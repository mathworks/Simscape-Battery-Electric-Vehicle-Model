classdef test_MotorDrivePmsmFem < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function html_is_uptodate(testcase)
      source_fullpath = FileTool2.getFileFullPath("MotorDrive_Workflow_RunFourSimulations.m");
      destination_fullpath = FileTool2.getFileFullPath("MotorDrive_Workflow_RunFourSimulations.html");

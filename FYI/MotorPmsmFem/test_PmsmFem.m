classdef test_PmsmFem < matlab.unittest.TestCase
  ...
  properties
    ModelName (1,1) string = "PmsmFem_TestModel"
  end  % properties
  ...
  methods (Test)
    ...
    function PassingTest_4(~)
      PmsmFem_Workflow_RunSimulation  % !test-target
    end  % function

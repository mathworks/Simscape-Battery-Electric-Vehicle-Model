classdef BlockSelectorUI < LiteApp8.Component.ComponentBase
  ...
  properties
    ...
    SetParametersToBlockCallback (:,1) {CodeTool1.mustBeFunctionHandleOrEmpty}

    GetParametersFromBlockCallback (:,1) {CodeTool1.mustBeFunctionHandleOrEmpty}
  ...
  methods
    ...
    function set.ModelFileFullPath(component, ModelFilePath)
      ...
      if not(isfile(ModelFilePath))
        ...
        msg = CodeTool1.i18n("Invalid model file: ") + ModelFilePath;
    ...
    function set.BlockPath(component, block_path)
      ...
      if not(any(component.BlockPathDropDownUI.Items == styled_block_path))
        ...
        msg = CodeTool1.i18n("Specified block path is not in the block path drop down items: ") + block_path;
    ...
    function callback_change_modelfile_dropdown(component)
      ...
      if not(isempty(component.FindBlockCallback)) && isa(component.FindBlockCallback, 'function_handle')
        ...
        if not(iscolumn(block_paths_from_callback) && class(block_paths_from_callback) == "string")
          msg = CodeTool1.i18n("FindBlockCallback must return a scalar or a column vector containing block paths as string.");
          if component.MainFigure.Visible
            title_word = CodeTool1.i18n("Error");
            uialert(component.MainFigure, msg, title_word)
      ...
      if num_blocks == 0
        msg = CodeTool1.i18n("Block was not found: ") + component.TargetSimscapeBlockNames;
        if component.MainFigure.Visible
          title_word = CodeTool1.i18n("Error");
          uialert(component.MainFigure, msg, title_word)
    ...
    function subcallback_make_block_path_ready(component)
      ...
      if component.BlockPathDropDownUI.Value == ""
        ...
        msg = CodeTool1.i18n("BlockPath must be specified.");
    ...
    function callback_open_model(component, NameValuePair)
      ...
      if NameValuePair.ModelFileFullPath ~= ""
        ...
        if not(isfile(component.ModelFileFullPath))
          ...
          msg = CodeTool1.i18n("Invalid file was specified: ") + NameValuePair.ModelFileFullPath;
    ...
    function callback_change_blockpath_dropdown(component)
      ...
      if getSimulinkBlockHandle(block_path) <= 0
        msg = CodeTool1.i18n("Block was not found: " + block_path);
        title_word = CodeTool1.i18n("Error");
        uialert(component.MainFigure, msg, title_word)
    ...
    function callback_hilit(component)
      ...
      if component.ModelFileDropDownUI.Value == ""
        ...
        msg = CodeTool1.i18n("To highlight a block, model file must be non-empty.");
      ...
      if selected_block_display_path == ""
        id = component.errorID + "InvalidBlockPath";
        msg = CodeTool1.i18n("To highlight a block, block path must be non-empty.");
      ...
      if component.HilitBlockUI.Value
        ...
        if getSimulinkBlockHandle(block_path) <= 0
          ...
          msg = CodeTool1.i18n("Specified block is invalid: " + block_path);
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.OpenModelUI.Text = CodeTool1.i18n("Open model");
      ...
      component.HilitBlockUI.Text = CodeTool1.i18n("Highlight");
      component.HilitBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "demoicon.gif");
      component.HilitBlockUI.MainButton.Tooltip = CodeTool1.i18n("Open the model, and highlight or dehighlight the selected block.");
      component.HilitBlockUI.MainButton.Enable = "off";
      ...
      component.GetParametersFromBlockUI.Text = CodeTool1.i18n("Get");
      component.GetParametersFromBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greencircleicon.gif");
      component.GetParametersFromBlockUI.MainButton.Tooltip = CodeTool1.i18n("Get parameters from the selected block.");
      component.GetParametersFromBlockUI.MainButton.Enable = "off";
      ...
      component.SetParametersToBlockUI.Text = CodeTool1.i18n("Set");
      component.SetParametersToBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greenarrowicon.gif");
      component.SetParametersToBlockUI.MainButton.Tooltip = CodeTool1.i18n("Set parameters to the selected block.");
      component.SetParametersToBlockUI.MainButton.Enable = "off";

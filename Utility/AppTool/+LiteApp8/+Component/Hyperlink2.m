classdef Hyperlink2 < LiteApp8.Component.ComponentBase
  % Hyperlink component, version 2
  %
  % This is a short component.
  % - Main component's height is fixed at one line.
  % - Main component's width expands to the whole component width.
  %
  % This version fixes the issue in the previous version where
  % the base grid was miused.

classdef uitest_EditableDropDown < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = EditableDropDown_testapp_1;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      ...
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = EditableDropDown_testapp_2;  % !test-target
      end  % nested function
    end  % function
    ...
    function Test_1(testcase)
      testcase.App = EditableDropDown_testapp_1;
    ...
    function Test_2(testcase)
      testcase.App = EditableDropDown_testapp_2;

      press(testcase, testcase.App.ButtonUI.MainButton)
      items = testcase.App.EditableDropDownUI.Items;
      verifyEqual(testcase, items, ["aa"; "bb"; "cc"; "Added"]);

      choose(testcase, testcase.App.EditableDropDownUI.MainDropDown, "bb")

      press(testcase, testcase.App.ButtonUI.MainButton)
      items = testcase.App.EditableDropDownUI.Items;
      verifyEqual(testcase, items, ["aa"; "bb"; "cc"; "Added"; "Added"]);

function App = testapp_Label_2_inner_align
...
link_11_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_12_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_13_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_21_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_22_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_23_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_31_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_32_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target
...
link_33_ui = LiteApp8.Component.Label(NewSlot(main_layout, app_row));  % !test-target

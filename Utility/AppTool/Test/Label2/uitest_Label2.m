classdef uitest_Label2 < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_launches_without_warnings_1(testcase)
      ...
      function target()
        testcase.App = testapp_Label2_1_bare_minimum;  % !test-target
      end  % nested function
    end  % function
    ...
    function app_launches_without_warnings_2(testcase)
      ...
      verifyWarningFree(testcase, @() target())
      function target()
        testcase.App = testapp_Label2_2_inner_align;  % !test-target
      end  % nested function
    end  % function

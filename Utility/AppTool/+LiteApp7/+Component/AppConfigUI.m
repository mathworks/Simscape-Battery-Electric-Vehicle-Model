classdef AppConfigUI < LiteApp7.Component.LiteAppComponentBase
  ...
  properties
    ...
    AppConfigObject (:,1)
    % {LiteApp7.Utility.mustBeAppConfigOrEmpty}  % !todo: This validator does not work. Fix it.

    % Called when changing an item in the drop down.
    LoadAppConfigToUIComponentsCallback (:,1) {CodeTool1.mustBeFunctionHandleOrEmpty}

    % Called before saving app-config to file.
    UpdateAppConfigFromUIComponentsCallback (:,1) {CodeTool1.mustBeFunctionHandleOrEmpty}

    % 
    ResetUIComponentsCallback (:,1 ) {CodeTool1.mustBeFunctionHandleOrEmpty}
    ...
    LabelUI LiteApp7.Component.Label
    ConfigFileDropDownUI LiteApp7.Component.DropDown
    OpenConfigButtonUI LiteApp7.Component.Button
    SaveButtonUI LiteApp7.Component.Button
    SaveAsButtonUI LiteApp7.Component.Button
  ...
  methods
    ...
    function set.ConfigFilePath(component, ConfigFileFullPath)
      ...
      if not(isfile(ConfigFileFullPath))
        ...
        msg = CodeTool1.i18n("Invalid config file: " + ConfigFileFullPath);
    ...
    function callback_change_appconfig_dropdown(component)
      ...
      try
        ...
        msg = CodeTool1.i18n("Reading config file failed." + newline + exception.message);
      ...
      try
        ...
        LiteApp7.Utility.setupAppConfigFromConfigStruct(component.AppConfigObject, new_app_config_struct)
      catch exception
        resetDropDown(component)
        ...
        msg = CodeTool1.i18n("App config could not be built." + newline + exception.message);
        title_word = CodeTool1.i18n("Error");
        uialert(component.MainFigure, msg, title_word)
    ...
    function addConfigFile(component, ConfigFileFullPath)
      ...
      if ConfigFileFullPath == ""
        ...
        msg = CodeTool1.i18n("Config file must be specified.");
    ...
    function callback_save_app_config_file(component)
      ...
      if not(isfile(configfile_fullpath))
        kwd = CodeTool1.i18n("Error");
        msg = CodeTool1.i18n("File not found:" + newline + configfile_fullpath);
    ...
    function saveAppConfigToFile(component, filenameFullpath)
      ...
      json_text = LiteApp7.Utility.buildJSONTextFromAppConfig(component.AppConfigObject);
      ...
      try
        ...
        title_word = CodeTool1.i18n("Error");
        msg = CodeTool1.i18n("Failed to save:") + newline + exception.message;
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.LabelUI = LiteApp7.Component.Label(component.baseGridObject);
      ...
      component.LabelUI.Text = CodeTool1.i18n("App config");

      component.ConfigFileDropDownUI = LiteApp7.Component.DropDown(component.baseGridObject);
      ...
      component.OpenConfigButtonUI = LiteApp7.Component.Button(component.baseGridObject);
      ...
      component.OpenConfigButtonUI.Text = CodeTool1.i18n("Open config");
      component.OpenConfigButtonUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "file_open.png");
      component.OpenConfigButtonUI.MainButton.Tooltip = CodeTool1.i18n("Open and load app configuration.");
      component.OpenConfigButtonUI.ButtonPushedCallback = @() callback_open_app_config_file(component);

      component.SaveButtonUI = LiteApp7.Component.Button(component.baseGridObject);
      ...
      component.SaveButtonUI.Text = CodeTool1.i18n("Save");
      component.SaveButtonUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "file_save.png");
      component.SaveButtonUI.MainButton.Tooltip = CodeTool1.i18n("Save app configuration to current config file.");
      component.SaveButtonUI.MainButton.Enable = "off";
      component.SaveButtonUI.ButtonPushedCallback = @() callback_save_app_config_file(component);

      component.SaveAsButtonUI = LiteApp7.Component.Button(component.baseGridObject);
      ...
      component.SaveAsButtonUI.Text = CodeTool1.i18n("Save As...");
      component.SaveAsButtonUI.MainButton.Tooltip = CodeTool1.i18n("Select file to save app configuration.");

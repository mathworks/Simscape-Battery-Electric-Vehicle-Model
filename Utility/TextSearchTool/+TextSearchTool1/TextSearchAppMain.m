  ...
  methods
    ...
    function App = TextSearchAppMain(NameValuePair)
      ...
      arguments (Input)
        ...
        NameValuePair.ExcludeMATLABCode (1,1) logical = false
        ...
        NameValuePair.SelectText (1,1) logical = true
        NameValuePair.AdditionalFileTypes (1,:) string = "*.m"
      ...
      App.ExcludeMATLABCodeFileUI.Value = NameValuePair.ExcludeMATLABCode;
    ...
    function update_file_types(App)
      %%
      % Use main components' Value (e.g., MainCheckBox.Value) to modify the value.
    ...
    function run_search(App)
      ...
      TextSearchTool1.TextSearchResultViewerAppMain(SearchResult=App.SearchResult);

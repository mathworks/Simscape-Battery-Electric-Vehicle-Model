classdef TextSearchResultViewerAppMain < handle
  ...
  properties
    ...
    SearchResult table = TextSearchTool1.newTextSearchTable(IncludeStyledFilePath=true)
  ...
  methods
    ...
    function App = TextSearchResultViewerAppMain(NameValuePair)
      %%
      arguments (Input)
        NameValuePair.SearchResult table {TextSearchTool1.mustBeTextSearchTable}
      end  % arguments

      arguments (Output)
        App TextSearchTool1.TextReplaceAppMain
      end  % arguments
    ...
    function build_app_gui(App)
      ...
      target_folder = App.SearchResult.Properties.CustomProperties.TargetFolder;
      ...
      editfield_ui = LiteApp7.Component.EditField(NewSlot(layout, row));
      editfield_ui.ReadOnly = "on";
      editfield_ui.Value = App.SearchResult.Properties.CustomProperties.FileTypesString;
      ...
      editfield_ui = LiteApp7.Component.EditField(NewSlot(layout, row));
      editfield_ui.ReadOnly = "on";
      editfield_ui.Value = string(App.SearchResult.Properties.CustomProperties.TextPatternString);
      ...
      App.TableUI.MainTable.Data = App.SearchResult(:, ["StyledFilePath", "LineNumber", "LineText"]);
    ...
    function react_RefreshButtonPushed(App)
      ...
      App.SearchResult = TextSearchTool1.refreshTextSearchResult(result, DisplayInfo=false);
      App.TableUI.MainTable.Data = App.SearchResult(:, ["StyledFilePath", "LineNumber", "LineText"]);
    end  % function

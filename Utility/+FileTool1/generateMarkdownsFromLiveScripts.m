...
% You can force generate a new Markdown by setting true to the ForceExport option.
...
arguments (Input)
  ...
  LiveScriptFilenames (:,1) string {FileTool1.mustBeLiveScript} = "MyLiveScript.mlx"
...
for idx = 1 : numSourceFiles
  ...
  do_generate = FileTool1.sourceFileIsNewer( ...
    Source = src, ...
    Destination = dst, ...

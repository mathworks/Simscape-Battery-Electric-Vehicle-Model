function fig = plotVehicle1DPerformance(NameValuePair)
...
arguments (Input)
  ...
  NameValuePair.DataSet Vehicle1D1.Vehicle1DDataSet {mustBeScalarOrEmpty}
  ...
  NameValuePair.AirDensity (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.AirDensity, "kg/m^3"), CodeUtil1.mustBeSimscapeValuePositiveOrNan } ...
...
errorID = "plotVehicle1DPerformance:";
...
if NameValuePair.DataSource == "direct"
  ...
  d_air = NameValuePair.AirDensity;
  ...
  if isfield(NameValuePair, "DataSet")
    ...
    DataSet = Vehicle1D1.Vehicle1DDataSet(Initialization=true);
  end  % if
...
%{
M_veh = setup_parameter("VehicleMass", simscape.Value(1800, "kg"));
...
plot_force_unit = NameValuePair.PlotForceUnit;
plot_speed_unit = NameValuePair.PlotSpeedUnit;
num_X = NameValuePair.NumSpeedPoints;
%}

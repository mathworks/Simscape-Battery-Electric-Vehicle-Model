classdef Vehicle1DDataSet < handle
  % Data set for the vehicle1d model for visualization.
  %
  ...
  properties (Access=private, Constant)
    errorID (1,1) string = "Vehicle1DDataSet:"
  end  % properties

  properties

    % Parameters of the target model
    ModelParams (1,1) Vehicle1D1.Vehicle1DModelParameters
  ...
  methods
    ...
    function DataSet = Vehicle1DDataSet(NameValuePair)
      %%
      arguments (Input)
      ...
      DataSet.ModelParams = Vehicle1D1.Vehicle1DModelParameters;
      ...
      if DataSet.ModelName == ""
        ...
        DataSet.ModelParams.TireRollingCoefficient = ModelUtil1.getDoubleValueFromBlockParameter(DataSet.BlockPath, "R_tireroll");
        ...
        DataSet.ModelParams.AirDensity = ModelUtil1.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "air_density");
    ...
    function resetDataSet(DataSet)
      ...
      DataSet.ModelParams.AirDensity = simscape.Value(1.184, "kg/m^3");

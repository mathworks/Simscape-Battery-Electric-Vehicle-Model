...
assert(num_fields > 0, error_id, LiteApp5.Utility.i18n("Struct without field is not accepted."))
...
if any(not_found)
  ...
  error_text = LiteApp5.Utility.i18n("Required properties were not found: " + join(missing_props, ", "));

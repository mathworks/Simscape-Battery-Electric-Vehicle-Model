...
ResultTable = table.empty; %#ok<NASGU>

if ModelName == ""
  id = "findSimscapeBlocks:ModelNotSpecified";
  msg = LiteApp5.Utility.i18n("Model name must be specified.");
...
if isempty(t_library_block) && isempty(t_component_block)
  id = errorID + "BlockNotFound";
  msg = LiteApp5.Utility.i18n("Block was not found.");

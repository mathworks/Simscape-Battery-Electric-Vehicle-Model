...
arguments (Input)
  ...
  TargetName (1,1) string {LiteApp5.Utility.mustBeNumericValueStringOrValidNameOrEmpty} = ""
end  % arguments
...
try
  result = LiteApp5.Utility.getNumericValueFromString(PropDict(TargetName));
catch exception

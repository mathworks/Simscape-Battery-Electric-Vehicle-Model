classdef LiteAppLayout < handle
  ...
  % An Area can contain Columns or LiteApp5.Component.
  %
  ...
  % A Column can contain Rows or LiteApp5.Component.
  %
  ...
  % A Row can contain Slots or LiteApp5.Component.
  %
  ...
  % A Slot can contain LiteApp5.Component.
  %
  ...
  %
  % LiteAppLayout is one of LiteApp5.Component.
  ...
  methods
    ...
    function newGrid = NewArea(layout, NameValuePair)
      ...
      arguments (Input)
        layout (1,1)
        NameValuePair.Height (1,1) {LiteApp5.Utility.mustBeStringOrPositiveInteger} = "fit"
      end
      arguments (Output)
    ...
    function newGrid = NewColumn(layout, currentGrid, NameValuePair)
      ...
      arguments (Input)
        ...
        % such as "1x", "2x", "fit", 100, 200 etc.
        NameValuePair.Width (1,1) {LiteApp5.Utility.mustBeStringOrPositiveInteger} = "1x"
      end
      arguments (Output)
        newGrid (1,1) matlab.ui.container.GridLayout
      end
    ...
    function newGrid = NewSlot(layout, currentGrid, NameValuePair)
      ...
      arguments (Input)
        ...
        % You can pass values as long as it is supported by ColumnWidth,
        % such as "1x", "2x", "fit", 100, 200 etc.
        NameValuePair.Width (1,:) {LiteApp5.Utility.mustBeStringOrPositiveInteger} = "1x"
      end
      arguments (Output)
        newGrid (1,1) matlab.ui.container.GridLayout
      end

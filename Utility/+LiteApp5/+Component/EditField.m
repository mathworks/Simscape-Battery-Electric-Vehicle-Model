classdef EditField < LiteApp5.Component.LiteAppComponentBase
  ...
  properties
    ...
    EditFieldHeight (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = LiteApp5.Utility.Constant.Height{"oneline+"}

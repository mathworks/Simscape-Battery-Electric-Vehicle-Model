classdef Hyperlink < LiteApp5.Component.LiteAppComponentBase
  %% Hyperlink component
  ...
  properties
    ...
    HyperlinkClickedCallback {LiteApp5.Utility.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = "1x";
    HyperlinkWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = "fit";

classdef WindowHeader < LiteApp5.Component.LiteAppComponentBase
  ...
  properties
    ...
    AppNameUI LiteApp5.Component.Label
    SourceLinkUI LiteApp5.Component.Hyperlink
    AlwaysOnTopUI LiteApp5.Component.CheckBox
  ...
  properties (Constant)
    common_height = LiteApp5.Utility.Constant.Height{"oneline++"}
  end  % properties
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        LiteApp5.Utility.ReportTimeAndFileLocation("Within setup")
      end  % if
      ...
      component.AppNameUI = LiteApp5.Component.Label(component.baseGridObject);
      ...
      component.SourceLinkUI = LiteApp5.Component.Hyperlink(component.baseGridObject);
      ...
      component.AlwaysOnTopUI = LiteApp5.Component.CheckBox(component.baseGridObject);
    ...
    function regular_update(component)
      ...
      if component.Reporting
        ...
        LiteApp5.Utility.ReportTimeAndFileLocation("component.AppName: " + component.AppName)
      end  % if

      % AppName can be defined by the user, first as the Name property of LiteApp5.LiteAppWindow.
      % Then it is passed to the AppName property of this class.
      % Because LiteApp5.LiteAppWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.Show_AlwaysOnTop_CheckBox)
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("not creating always-on-top check box")
        end  % if
        checkbox_ui_width = 0;
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if not(isvalid(component.AlwaysOnTopUI))
        % ignore
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("invalid because always-on-top check box was not created")
        end  % if
      ...
      if isempty(component.ParentFigure)
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("invalid because ParentFigure is empty")
        end  % if
    ...
    function RawSetAlwaysOnTop(component, on_flag)
      ...
      if on_flag
        ...
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("ParentFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.ParentFigure.WindowStyle = "normal";
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("ParentFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

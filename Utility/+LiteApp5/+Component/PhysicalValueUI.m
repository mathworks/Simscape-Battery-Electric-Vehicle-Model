classdef PhysicalValueUI < LiteApp5.Component.LiteAppComponentBase
  ...
  properties
    ...
    UnitChangedCallback {LiteApp5.Utility.mustBeFunctionHandleOrEmpty} = []
    ...
    NameUIWidth (1,1) double {mustBePositive} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 14
    InfoUIWidth (1,1) double {mustBePositive} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 10
    UnitUIWidth (1,1) double {mustBePositive} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 10
  ...
  properties
    % Parameter name.
    NameUI LiteApp5.Component.Label
    ...
    ValueEditFieldUI LiteApp5.Component.EditField
    ...
    InfoUI LiteApp5.Component.EditField
    ...
    UnitDropDownUI LiteApp5.Component.DropDown
    UnitLabelUI LiteApp5.Component.Label
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.NameUI = LiteApp5.Component.Label(component.NameColumnContainer);
      ...
      component.ValueEditFieldUI = LiteApp5.Component.EditField(component.ValueColumnContainer);
      ...
      component.InfoUI = LiteApp5.Component.EditField(component.InfoColumnContainer);
      ...
      component.UnitLabelUI = LiteApp5.Component.Label(component.UnitColumnContainer);
      ...
      component.UnitDropDownUI = LiteApp5.Component.DropDown(component.UnitColumnContainer);
  ...
  methods
    ...
    function set.SimscapeValue(component, x)
      ...
      component.Value = LiteApp5.Utility.Stringify(component.current_numeric_value);
    ...
    function set.UnitItems(component, items)
      ...
      arguments (Input)
        ...
        items (1,:) string {LiteApp5.SimscapeUtility.mustBeAllCommensurateUnit}
    ...
    function set.UnitAlias(component, AliasString)
      ...
      if component.unit_specified
        component.HasError = true;
        component.ErrorMessage = "UnitAlias cannot be set because unit specification is already defined";

        error(component.ErrorMessage)  % !wip: app must not open
  ...
  methods (Access=private)
    ...
    function [Result, NotOK] = getNumericValueFromValueUI(component)
      ...
      [Result, error_message] = LiteApp5.SimscapeUtility.AnalyzeValueString(original_value_ui_string);
      % The result may be of type double or of type simscape.Value.
      % Do error checks before changing any states of the component.
      if error_message ~= ""
        component.HasError = true;
      ...
      % if isfield(Result, "NumericValue")
      component.current_numeric_value = Result.NumericValue;
      % end  % if

classdef EnabledButton < LiteApp5.Component.LiteAppComponentBase
  ...
  properties
    ...
    CheckBoxValueChangedCallback {LiteApp5.Utility.mustBeFunctionHandleOrEmpty} = []
    ...
    ButtonUIWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 11
    ...
    CheckBoxUIWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 9
    CheckBoxWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = LiteApp5.Utility.Constant.Width{"unitwidth"} * 8
    % There is no CheckBoxHeight property.
    % The height of the main check box is fixed by uicheckbox.

    ButtonUI LiteApp5.Component.Button
    CheckBoxUI LiteApp5.Component.CheckBox {mustBeScalarOrEmpty}
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      % -----------------------------------------------------------------------
      % Button
      component.ButtonUI = LiteApp5.Component.Button(component.compositeGrid);
      ...
      % -----------------------------------------------------------------------
      % Check box
      component.CheckBoxUI = LiteApp5.Component.CheckBox(component.compositeGrid);

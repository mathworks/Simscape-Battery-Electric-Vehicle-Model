classdef AppConfigUI < LiteApp5.Component.LiteAppComponentBase
  ...
  properties
    ...
    AppConfigObject (:,1)
    % {LiteApp5.Utility.mustBeAppConfigOrEmpty}  % !todo: This validator does not work. Fix it.

    % Called when changing an item in the drop down.
    LoadAppConfigToUIComponentsCallback (:,1) {LiteApp5.Utility.mustBeFunctionHandleOrEmpty}

    % Called before saving app-config to file.
    UpdateAppConfigFromUIComponentsCallback (:,1) {LiteApp5.Utility.mustBeFunctionHandleOrEmpty}

    % 
    ResetUIComponentsCallback (:,1 ) {LiteApp5.Utility.mustBeFunctionHandleOrEmpty}
    ...
    LabelUI LiteApp5.Component.Label
    ConfigFileDropDownUI LiteApp5.Component.DropDown
    OpenConfigButtonUI LiteApp5.Component.Button
    SaveButtonUI LiteApp5.Component.Button
    SaveAsButtonUI LiteApp5.Component.Button
  ...
  methods
    ...
    function set.ConfigFilePath(component, ConfigFileFullPath)
      ...
      if not(isfile(ConfigFileFullPath))
        ...
        msg = LiteApp5.Utility.i18n("Invalid config file: " + ConfigFileFullPath);
    ...
    function callback_change_appconfig_dropdown(component)
      ...
      if component.Reporting
        LiteApp5.Utility.ReportTimeAndFileLocation("Selected: [" + selected_configfile_display_path + "]")
      end  % if
      ...
      try
        ...
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("caught exception")
        end  % if
        resetDropDown(component)
        ...
        msg = LiteApp5.Utility.i18n("Reading config file failed." + newline + exception.message);
      ...
      if isempty(component.AppConfigObject)
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("AppConfigObject is empty.")
        end  % if
      ...
      try
        ...
        LiteApp5.Utility.setupAppConfigFromConfigStruct(component.AppConfigObject, new_app_config_struct)
      catch exception
        resetDropDown(component)
        ...
        msg = LiteApp5.Utility.i18n("App config could not be built." + newline + exception.message);
        title_word = LiteApp5.Utility.i18n("Error");
        uialert(component.MainFigure, msg, title_word)
      ...
      if not(isempty(component.LoadAppConfigToUIComponentsCallback))
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("calling LoadAppConfigToUIComponentsCallback")
        end  % if
    ...
    function addConfigFile(component, ConfigFileFullPath)
      ...
      if ConfigFileFullPath == ""
        ...
        msg = LiteApp5.Utility.i18n("Config file must be specified.");
    ...
    function callback_save_app_config_file(component)
      %%
      if component.Reporting
        LiteApp5.Utility.ReportTimeAndFileLocation("Save")
      end  % if
      ...
      if not(isfile(configfile_fullpath))
        kwd = LiteApp5.Utility.i18n("Error");
        msg = LiteApp5.Utility.i18n("File not found:" + newline + configfile_fullpath);
    ...
    function callback_save_app_config_file_as(component)
      ...
      filename = LiteApp5.Utility.getUnusedFilename(component.defaultConfigFilename);
      if component.Reporting
        LiteApp5.Utility.ReportTimeAndFileLocation("Unused file name: " + filename)
      end  % if
    ...
    function saveAppConfigToFile(component, filenameFullpath)
      ...
      if isempty(component.AppConfigObject)
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("AppConfigObject is empty. Not saving.")
        end  % if
      ...
      if not(isempty(component.UpdateAppConfigFromUIComponentsCallback))
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("calling UpdateAppConfigFromUIComponentsCallback")
        end  % if
      ...
      json_text = LiteApp5.Utility.buildJSONTextFromAppConfig(component.AppConfigObject);

      try
        if component.Reporting
          LiteApp5.Utility.ReportTimeAndFileLocation("Writing to file.")
        end  % if
        ...
        title_word = LiteApp5.Utility.i18n("Error");
        msg = LiteApp5.Utility.i18n("Failed to save:") + newline + exception.message;
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        LiteApp5.Utility.ReportTimeAndFileLocation("Setup")
      end  % if
      ...
      component.LabelUI = LiteApp5.Component.Label(component.baseGridObject);
      ...
      component.LabelUI.Text = LiteApp5.Utility.i18n("App config");

      component.ConfigFileDropDownUI = LiteApp5.Component.DropDown(component.baseGridObject);
      ...
      component.OpenConfigButtonUI = LiteApp5.Component.Button(component.baseGridObject);
      ...
      component.OpenConfigButtonUI.Text = LiteApp5.Utility.i18n("Open config");
      component.OpenConfigButtonUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "file_open.png");
      component.OpenConfigButtonUI.MainButton.Tooltip = LiteApp5.Utility.i18n("Open and load app configuration.");
      component.OpenConfigButtonUI.ButtonPushedCallback = @() callback_open_app_config_file(component);

      component.SaveButtonUI = LiteApp5.Component.Button(component.baseGridObject);
      ...
      component.SaveButtonUI.Text = LiteApp5.Utility.i18n("Save");
      component.SaveButtonUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "file_save.png");
      component.SaveButtonUI.MainButton.Tooltip = LiteApp5.Utility.i18n("Save app configuration to current config file.");
      component.SaveButtonUI.MainButton.Enable = "off";
      component.SaveButtonUI.ButtonPushedCallback = @() callback_save_app_config_file(component);

      component.SaveAsButtonUI = LiteApp5.Component.Button(component.baseGridObject);
      ...
      component.SaveAsButtonUI.Text = LiteApp5.Utility.i18n("Save As...");
      component.SaveAsButtonUI.MainButton.Tooltip = LiteApp5.Utility.i18n("Select file to save app configuration.");

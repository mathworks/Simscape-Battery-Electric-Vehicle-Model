classdef DropDown < LiteApp5.Component.LiteAppComponentBase
  %% Drop down component
  ...
  properties
    ...
    DropDownWidth (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = "1x"
    ...
    DropDownHeight (1,:) {LiteApp5.Utility.mustBeTextOrPositiveNumber} = LiteApp5.Utility.Constant.Height{"oneline+"}

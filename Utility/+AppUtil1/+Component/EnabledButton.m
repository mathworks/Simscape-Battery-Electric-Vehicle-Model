classdef EnabledButton < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    CheckBoxValueChangedCallback {CodeUtil1.mustBeFunctionHandleOrEmpty} = []
    ...
    ButtonUIWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = AppUtil1.Constant.Width{"unitwidth"} * 11
    ...
    CheckBoxUIWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = "fit"
    CheckBoxWidth (1,:) {CodeUtil1.mustBeTextOrPositiveNumber} = "fit"
    % There is no CheckBoxHeight property.
    % The height of the main check box is fixed by uicheckbox.

    ButtonUI AppUtil1.Component.Button
    CheckBoxUI AppUtil1.Component.CheckBox {mustBeScalarOrEmpty}
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      % -----------------------------------------------------------------------
      % Button
      component.ButtonUI = AppUtil1.Component.Button(component.composite_grid);
      ...
      % -----------------------------------------------------------------------
      % Check box
      component.CheckBoxUI = AppUtil1.Component.CheckBox(component.composite_grid);

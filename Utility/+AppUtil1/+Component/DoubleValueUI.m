classdef DoubleValueUI < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    double_value (1,:) CodeUtil1.DoubleValue
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.double_value = CodeUtil1.DoubleValue;
      ...
      component.SideNoteUI = AppUtil1.Component.Label(component.sidenote_layout);

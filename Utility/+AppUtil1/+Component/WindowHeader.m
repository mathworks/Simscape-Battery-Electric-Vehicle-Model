classdef WindowHeader < AppUtil1.Component.ComponentBase
  ...
  properties
    ...
    AppName (1,1) string = CodeUtil1.i18n("App")
  ...
  methods (Access=protected)
    ...
    function regular_update(component)
      ...
      % AppName can be defined by the user, first as the Name property of AppUtil1.AppWindow.
      % Then it is passed to the AppName property of this class.
      % Because AppUtil1.AppWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.UseCheckBoxForAlwaysOnTop)
        ...
        if isempty(component.MainFigure)
          ...
          component.AlwaysOnTopUI.MainCheckBox.Tooltip = CodeUtil1.i18n("Main figure is not defined.");
        else
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if isempty(component.MainFigure)
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("invalid because MainFigure is empty")
        end  % if
        valid = false;
    ...
    function configureWindowStyle(component, alwasy_on_top)
      ...
      if alwasy_on_top
        ...
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("MainFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.MainFigure.WindowStyle = "normal";
        if component.Reporting
          FileUtil1.displayTimeAndFileLocation("MainFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

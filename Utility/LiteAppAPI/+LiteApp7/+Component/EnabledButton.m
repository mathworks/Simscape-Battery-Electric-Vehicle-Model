classdef EnabledButton < LiteApp7.Component.LiteAppComponentBase
  ...
  properties
    ...
    CheckBoxUIWidth (1,:) {CodeTool1.mustBeTextOrPositiveNumber} = LiteApp7.Constant.Width{"unitwidth"} * 9
    CheckBoxWidth (1,:) {CodeTool1.mustBeTextOrPositiveNumber} = LiteApp7.Constant.Width{"unitwidth"} * 8
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      % -----------------------------------------------------------------------
      % Button
      component.ButtonUI = LiteApp7.Component.Button(component.compositeGrid);
      ...
      % -----------------------------------------------------------------------
      % Check box
      component.CheckBoxUI = LiteApp7.Component.CheckBox(component.compositeGrid);

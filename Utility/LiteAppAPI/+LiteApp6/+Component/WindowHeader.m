classdef WindowHeader < LiteApp6.Component.LiteAppComponentBase
  ...
  properties
    ...
    AppNameUI LiteApp6.Component.Label
    SourceLinkUI LiteApp6.Component.Hyperlink
    AlwaysOnTopUI LiteApp6.Component.CheckBox
  ...
  properties (Constant)
    common_height = LiteApp6.Utility.Constant.Height{"oneline++"}
  end  % properties
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        LiteApp6.Utility.displayTimeAndFileLocation("Within setup")
      end  % if
      ...
      component.AppNameUI = LiteApp6.Component.Label(component.baseGridObject);
      ...
      component.SourceLinkUI = LiteApp6.Component.Hyperlink(component.baseGridObject);
      ...
      component.AlwaysOnTopUI = LiteApp6.Component.CheckBox(component.baseGridObject);
    ...
    function regular_update(component)
      ...
      if component.Reporting
        ...
        LiteApp6.Utility.displayTimeAndFileLocation("component.AppName: " + component.AppName)
      end  % if

      % AppName can be defined by the user, first as the Name property of LiteApp6.LiteAppWindow.
      % Then it is passed to the AppName property of this class.
      % Because LiteApp6.LiteAppWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.Show_AlwaysOnTop_CheckBox)
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("not creating always-on-top check box")
        end  % if
        checkbox_ui_width = 0;
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if not(isvalid(component.AlwaysOnTopUI))
        % ignore
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("invalid because always-on-top check box was not created")
        end  % if
      ...
      if isempty(component.ParentFigure)
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("invalid because ParentFigure is empty")
        end  % if
    ...
    function RawSetAlwaysOnTop(component, on_flag)
      ...
      if on_flag
        ...
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("ParentFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.ParentFigure.WindowStyle = "normal";
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("ParentFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

classdef PhysicalValueUI < LiteApp6.Component.LiteAppComponentBase
  ...
  properties
    ...
    UnitChangedCallback {LiteApp6.Utility.mustBeFunctionHandleOrEmpty} = []
    ...
    NameUIWidth (1,1) double {mustBePositive} = LiteApp6.Utility.Constant.Width{"unitwidth"} * 14
    InfoUIWidth (1,1) double {mustBePositive} = LiteApp6.Utility.Constant.Width{"unitwidth"} * 10
    UnitUIWidth (1,1) double {mustBePositive} = LiteApp6.Utility.Constant.Width{"unitwidth"} * 10
  ...
  properties
    % Parameter name.
    NameUI LiteApp6.Component.Label
    ...
    ValueEditFieldUI LiteApp6.Component.EditField
    ...
    InfoUI LiteApp6.Component.EditField
    ...
    UnitDropDownUI LiteApp6.Component.DropDown
    UnitLabelUI LiteApp6.Component.Label
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.NameUI = LiteApp6.Component.Label(component.NameColumnContainer);
      ...
      component.ValueEditFieldUI = LiteApp6.Component.EditField(component.ValueColumnContainer);
      ...
      component.InfoUI = LiteApp6.Component.EditField(component.InfoColumnContainer);
      ...
      component.UnitLabelUI = LiteApp6.Component.Label(component.UnitColumnContainer);
      ...
      component.UnitDropDownUI = LiteApp6.Component.DropDown(component.UnitColumnContainer);
  ...
  methods
    ...
    function set.SimscapeValue(component, x)
      ...
      component.Value = LiteApp6.Utility.stringify(component.current_numeric_value);
    ...
    function set.UnitItems(component, items)
      ...
      arguments (Input)
        ...
        items (1,:) string {LiteApp6.SimscapeUtility.mustBeAllCommensurateUnit}
  ...
  methods (Access=private)
    ...
    function [Result, NotOK] = getNumericValueFromValueUI(component)
      ...
      try
        ...
        Result = LiteApp6.SimscapeUtility.getDoubleOrSimscapeValueFromString(original_value_ui_string);
      catch exception
        component.HasError = true;
        component.ErrorMessage = exception.message;
        NotOK = true;

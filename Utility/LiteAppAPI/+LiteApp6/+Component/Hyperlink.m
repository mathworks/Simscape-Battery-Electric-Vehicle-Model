classdef Hyperlink < LiteApp6.Component.LiteAppComponentBase
  %% Hyperlink component
  ...
  properties
    ...
    HyperlinkClickedCallback {LiteApp6.Utility.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {LiteApp6.Utility.mustBeTextOrPositiveNumber} = "1x";
    HyperlinkWidth (1,:) {LiteApp6.Utility.mustBeTextOrPositiveNumber} = "fit";

classdef EditField < LiteApp6.Component.LiteAppComponentBase
  ...
  properties
    ...
    EditFieldHeight (1,:) {LiteApp6.Utility.mustBeTextOrPositiveNumber} = LiteApp6.Utility.Constant.Height{"oneline+"}

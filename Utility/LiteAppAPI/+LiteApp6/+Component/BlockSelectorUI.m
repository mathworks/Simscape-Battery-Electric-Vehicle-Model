classdef BlockSelectorUI < LiteApp6.Component.LiteAppComponentBase
  ...
  properties
    ...
    %
    % LiteApp6.Utility.find1DLookupTableBlocks function can be used for FindBlockCallback.
    % It adds Simulink 1-D Lookup Table blocks in the Block Path drop down.
    FindBlockCallback {LiteApp6.Utility.mustBeFunctionHandleOrEmpty}
    ...
    SetParametersToBlockCallback (:,1) {LiteApp6.Utility.mustBeFunctionHandleOrEmpty}

    GetParametersFromBlockCallback (:,1) {LiteApp6.Utility.mustBeFunctionHandleOrEmpty}
    ...
    % For the "Model file"
    ModelFileTextUI LiteApp6.Component.Label
    ModelFileDropDownUI LiteApp6.Component.DropDown
    OpenModelUI LiteApp6.Component.Button

    % For the "Block path"
    BlockPathTextUI LiteApp6.Component.Label
    BlockPathDropDownUI LiteApp6.Component.DropDown
    HilitBlockUI LiteApp6.Component.StateButton
    GetParametersFromBlockUI LiteApp6.Component.Button
    SetParametersToBlockUI LiteApp6.Component.Button
  ...
  methods
    ...
    function set.ModelFileFullPath(component, ModelFilePath)
      ...
      if not(isfile(ModelFilePath))
        ...
        msg = LiteApp6.Utility.i18n("Invalid model file: ") + ModelFilePath;
    ...
    function set.BlockPath(component, block_path)
      ...
      if not(any(component.BlockPathDropDownUI.Items == styled_block_path))
        ...
        msg = LiteApp6.Utility.i18n("Specified block path is not in the block path drop down items: ") + block_path;
    ...
    function callback_change_modelfile_dropdown(component)
      ...
      if component.TargetSimscapeBlockNames == ""
        ...
        try
          result_table = LiteApp6.SimscapeUtility.findSimscapeBlocks(component.ModelName);
        catch exception
          uialert(component.MainFigure, exception.message, LiteApp6.Utility.i18n("Error"))
      ...
      if not(isempty(component.FindBlockCallback)) && isa(component.FindBlockCallback, 'function_handle')
        ...
        if not(iscolumn(block_paths_from_callback) && class(block_paths_from_callback) == "string")
          msg = LiteApp6.Utility.i18n("FindBlockCallback must return a scalar or a column vector containing block paths as string.");
          if component.MainFigure.Visible
            title_word = LiteApp6.Utility.i18n("Error");
            uialert(component.MainFigure, msg, title_word)
      ...
      if num_blocks == 0
        msg = LiteApp6.Utility.i18n("Block was not found: ") + component.TargetSimscapeBlockNames;
        if component.MainFigure.Visible
          title_word = LiteApp6.Utility.i18n("Error");
          uialert(component.MainFigure, msg, title_word)
    ...
    function subcallback_make_block_path_ready(component)
      ...
      if component.BlockPathDropDownUI.Value == ""
        ...
        msg = LiteApp6.Utility.i18n("BlockPath must be specified.");
    ...
    function callback_open_model(component, NameValuePair)
      ...
      if NameValuePair.ModelFileFullPath ~= ""
        ...
        if not(isfile(component.ModelFileFullPath))
          ...
          msg = LiteApp6.Utility.i18n("Invalid file was specified: ") + NameValuePair.ModelFileFullPath;
      ...
      if component.Reporting
        LiteApp6.Utility.displayTimeAndFileLocation("ModelFileDropDownUI.Value: " + component.ModelFileDropDownUI.Value)
      end  % if
    end  % function
    ...
    function callback_change_blockpath_dropdown(component)
      ...
      if component.ModelFileDropDownUI.Value == ""
        if component.Reporting
          LiteApp6.Utility.displayTimeAndFileLocation("Selected empty model file.")
        end  % if
      ...
      if getSimulinkBlockHandle(block_path) <= 0
        msg = LiteApp6.Utility.i18n("Block was not found: " + block_path);
        title_word = LiteApp6.Utility.i18n("Error");
        uialert(component.MainFigure, msg, title_word)
    ...
    function callback_hilit(component)
      ...
      if component.ModelFileDropDownUI.Value == ""
        ...
        msg = LiteApp6.Utility.i18n("To highlight a block, model file must be non-empty.");
      ...
      if selected_block_display_path == ""
        id = component.errorID + "InvalidBlockPath";
        msg = LiteApp6.Utility.i18n("To highlight a block, block path must be non-empty.");
      ...
      if component.HilitBlockUI.Value
        ...
        if getSimulinkBlockHandle(block_path) <= 0
          ...
          msg = LiteApp6.Utility.i18n("Specified block is invalid: " + block_path);
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.ModelFileTextUI = LiteApp6.Component.Label(component.baseGridObject);
      component.ModelFileTextUI.Layout.Row = 1;
      component.ModelFileTextUI.Layout.Column = 1;
      component.ModelFileTextUI.Text = LiteApp6.Utility.i18n("Model file");
      component.ModelFileTextUI.ComponentWidth = label_width;

      component.ModelFileDropDownUI = LiteApp6.Component.DropDown(component.baseGridObject);
      ...
      component.OpenModelUI = LiteApp6.Component.Button(component.baseGridObject);
      ...
      component.OpenModelUI.Text = LiteApp6.Utility.i18n("Open model");
      ...
      component.BlockPathTextUI = LiteApp6.Component.Label(component.baseGridObject);
      ...
      component.BlockPathTextUI.Text = LiteApp6.Utility.i18n("Block path");

      component.BlockPathDropDownUI = LiteApp6.Component.DropDown(component.baseGridObject);
      ...
      component.HilitBlockUI = LiteApp6.Component.StateButton(component.baseGridObject);
      ...
      component.HilitBlockUI.Text = LiteApp6.Utility.i18n("Highlight");
      component.HilitBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "demoicon.gif");
      component.HilitBlockUI.MainButton.Tooltip = LiteApp6.Utility.i18n("Open the model, and highlight or dehighlight the selected block.");
      component.HilitBlockUI.MainButton.Enable = "off";
      component.HilitBlockUI.ValueChangedCallback = @() callback_hilit(component);

      component.GetParametersFromBlockUI = LiteApp6.Component.Button(component.baseGridObject);
      ...
      component.GetParametersFromBlockUI.Text = LiteApp6.Utility.i18n("Get");
      component.GetParametersFromBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greencircleicon.gif");
      component.GetParametersFromBlockUI.MainButton.Tooltip = LiteApp6.Utility.i18n("Get parameters from the selected block.");
      component.GetParametersFromBlockUI.MainButton.Enable = "off";
      component.GetParametersFromBlockUI.ButtonPushedCallback = @() callback_get_parameters(component);

      component.SetParametersToBlockUI = LiteApp6.Component.Button(component.baseGridObject);
      ...
      component.SetParametersToBlockUI.Text = LiteApp6.Utility.i18n("Set");
      component.SetParametersToBlockUI.MainButton.Icon = fullfile(matlabroot, "toolbox", "matlab", "icons", "greenarrowicon.gif");
      component.SetParametersToBlockUI.MainButton.Tooltip = LiteApp6.Utility.i18n("Set parameters to the selected block.");
      component.SetParametersToBlockUI.MainButton.Enable = "off";

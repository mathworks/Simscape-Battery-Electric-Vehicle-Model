...
arguments (Input)
  AppConfigObj (1,1) {LiteApp6.Utility.mustBeAppConfig}
...
assert(num_fields > 0, error_id, LiteApp6.Utility.i18n("Struct without field is not accepted."))
...
if any(not_found)
  ...
  error_text = LiteApp6.Utility.i18n("Required properties were not found: " + join(missing_props, ", "));

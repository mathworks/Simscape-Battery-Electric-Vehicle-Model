classdef uptodatetest_SignalTool_Utility < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function html_with_code_is_uptodate_1(testcase)
      ...
      source_fullpath = FileTool3.getFileFullPath("SignalTool_Description.m");
      destination_fullpath = FileTool3.getFileFullPath("SignalTool_Description.html");
    ...
    function html_with_code_is_uptodate_2(testcase)
      ...
      source_fullpath = FileTool3.getFileFullPath("TimedTraceBuilderApp_Description.m");
      destination_fullpath = FileTool3.getFileFullPath("TimedTraceBuilderApp_Description.html");

classdef SignalDesignAppMain < handle
  ...
  properties
    ...
    MatrixTextUI LiteApp6.Component.TextArea
    InterpUI LiteApp6.Component.DropDown
    ExtrapUI LiteApp6.Component.DropDown

    TableGridVectorUI LiteApp6.Component.PhysicalValueUI
    TableValuesUI LiteApp6.Component.PhysicalValueUI

    PlotButtonUI LiteApp6.Component.EnabledButton
    OpenInFigureWindowUI LiteApp6.Component.Hyperlink
    AxesUI LiteApp6.Graphics.Axes
    IntervalUI LiteApp6.Component.PhysicalValueUI
    LowerUI LiteApp6.Component.PhysicalValueUI
    UpperUI LiteApp6.Component.PhysicalValueUI
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = LiteApp6.Utility.Constant.Width{"unitwidth"} * 18
    unit_ui_width = LiteApp6.Utility.Constant.Width{"unitwidth"} * 8
  ...
  methods
    ...
    function App = SignalDesignAppMain(NameValuePair)
      ...
      arguments (Output)
        App SignalTool1.SignalDesignAppMain
      end  % arguments
      ...
      if NameValuePair.BlockPath ~= ""
        ...
        App.ModelFileFullPath = FileTool1.getFileFullPath(model_name);
        App.BlockPath = NameValuePair.BlockPath;
      end  % if

      App.Window = LiteApp6.LiteAppWindow;
    ...
    function build_app_gui(App)
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.MatrixTextUI = LiteApp6.Component.TextArea(NewSlot(layout, row));
      ...
      App.InterpUI= LiteApp6.Component.DropDown(NewSlot(layout, row));
      ...
      App.ExtrapUI= LiteApp6.Component.DropDown(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.TableGridVectorUI = LiteApp6.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.TableValuesUI = LiteApp6.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      App.PlotButtonUI = LiteApp6.Component.EnabledButton(NewSlot(layout, row, Width="fit"));
      ...
      App.OpenInFigureWindowUI = LiteApp6.Component.Hyperlink(NewSlot(layout, row));
      ...
      App.AxesUI = LiteApp6.Graphics.Axes(NewSlot(layout, row));
      App.AxesUI.ComponentHeight = 300;

      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.IntervalUI = LiteApp6.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.LowerUI = LiteApp6.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      % -----------------------------------------------------------------------
      row = NewRow(layout, column);
      App.UpperUI = LiteApp6.Component.PhysicalValueUI(NewSlot(layout, row));
      ...
      App.SelectorUI.FindBlockCallback = @SignalTool1.find1DLookupTableBlocks;
    ...
    function change_design_matrix(App)
      ...
      App.TableGridVectorUI.Value = LiteApp6.Utility.stringify(result.X');
      App.TableValuesUI.Value = LiteApp6.Utility.stringify(result.Y');
    ...
    function getParam(App)
      ...
      try
        ...
        SignalTool1.getSignalDesignMatrixFromBlockDescription(block_path);
      catch exception
        % Restore the previous plot auto-update setting.
        App.PlotButtonUI.CheckBoxUI.Value = previous_auto_plot_state;
        if App.Window.MainFigure.Visible

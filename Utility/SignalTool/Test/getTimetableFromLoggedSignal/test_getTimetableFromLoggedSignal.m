classdef test_getTimetableFromLoggedSignal < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_5(~)
      ...
      getTimetableFromLoggedSignal_sample_script
    end  % function
    ...
    function Test_3(testcase)
      ...
      signal_timetable = SignalTool1.getTimetableFromLoggedSignal(dataset);  % !test-target

classdef PhysicalUnitDropDown < bev1mus.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    DropDownUI bev1mus.AppUtil.Component.DropDown
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.DropDownUI = bev1mus.AppUtil.Component.DropDown(component.main_h_layout);
    ...
    function regular_update(component)
      ...
      if component.HighlightBackground
        ...
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("2:ThemeNameForBackGroundHighlight=" + component.ThemeNameForBackGroundHighlight)
        end  % if
  ...
  methods
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      arguments (Input)
        component
        NewUnitItems (1,:) string %{ bev1mus.CodeUtil.mustBeAllCommensurateUnit }
      end  % arguments
      if component.Reporting
        bev1mus.FileUtil.displayTimeAndFileLocation("1")
      end  % if
      ...
      if component.UnitSpecified
        ...
        msg = bev1mus.CodeUtil.i18n("UnitItems can be defined only once.");
      ...
      try
        bev1mus.CodeUtil.mustBePhysicalUnit(NewUnitItems)
        bev1mus.CodeUtil.mustBeAllCommensurateUnit(NewUnitItems)
      catch exception
        ...
        if main_figure.Visible
          ...
          if component.Reporting
            bev1mus.FileUtil.displayTimeAndFileLocation("3")
          end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      if component.Editable
        ...
        try
          bev1mus.CodeUtil.mustBePhysicalUnit(NewUnitText)
        catch exception
        ...
        if component.UnitSpecified
          if not(simscape.isCommensurateUnit(NewUnitText, current_unit_items{:}))
            ...
            msg = bev1mus.CodeUtil.i18n("New unit must be commensurate with the defined units.");
            main_figure = ancestor(component, "figure");
            if main_figure.Visible
              window_title = bev1mus.CodeUtil.i18n("Error");
              uialert(main_figure, msg, window_title)
          ...
          if not(ismember(NewUnitText, current_unit_items))
            if component.Reporting
              bev1mus.FileUtil.displayTimeAndFileLocation("2:add:" + NewUnitText)
            end  % if
          ...
          if component.Reporting
            bev1mus.FileUtil.displayTimeAndFileLocation("3:new:" + NewUnitText)
          end  % if
        ...
        if not(component.UnitSpecified)
          msg = bev1mus.CodeUtil.i18n("UnitItems must be defined before assigning a value to UnitText.");
          main_figure = ancestor(component, "figure");
          if main_figure.Visible
            window_title = bev1mus.CodeUtil.i18n("Error");
            uialert(main_figure, msg, window_title)
        ...
        if not(ismember(NewUnitText, current_unit_items))
          ...
          if not(match_found)
            msg = bev1mus.CodeUtil.i18n("UnitText must be one of UnitItems: ") + NewUnitText;
            main_figure = ancestor(component, "figure");
            if main_figure.Visible
              window_title = bev1mus.CodeUtil.i18n("Error");
              uialert(main_figure, msg, window_title)

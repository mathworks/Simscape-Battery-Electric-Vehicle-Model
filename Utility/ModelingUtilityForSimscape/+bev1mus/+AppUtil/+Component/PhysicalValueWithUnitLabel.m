classdef PhysicalValueWithUnitLabel < bev1mus.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    physical_value bev1mus.CodeUtil.PhysicalValue % = bev1mus.CodeUtil.PhysicalValue
  ...
  properties
    ...
    UnitLabelUI bev1mus.AppUtil.Component.PhysicalUnitLabel
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.UnitLabelUI = bev1mus.AppUtil.Component.PhysicalUnitLabel(component.unit_layout);
  ...
  methods
    ...
    function set.UnitText(component, NewUnitText)
      ...
      try
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("3:UnitLabelUI.UnitText:" + NewUnitText)
        end  % if
    ...
    function set.UnitAlias(component, NewUnitAlias)
      ...
      if component.Reporting
        bev1mus.FileUtil.displayTimeAndFileLocation("3:UnitLabelUI.UnitAlias:" + NewUnitAlias)
      end  % if

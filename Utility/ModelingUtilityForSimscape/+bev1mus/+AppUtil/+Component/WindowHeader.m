classdef WindowHeader < bev1mus.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    AppName (1,1) string = bev1mus.CodeUtil.i18n("App")
    ...
    AppNameUI bev1mus.AppUtil.Component.Label
    SourceLinkUI bev1mus.AppUtil.Component.Hyperlink
    AlwaysOnTopUI bev1mus.AppUtil.Component.CheckBox
  ...
  properties (Constant)
    common_height = bev1mus.AppUtil.Constant.Height{"oneline++"}
  end  % properties
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      if component.Reporting
        ...
        bev1mus.FileUtil.displayTimeAndFileLocation("Within setup")
      end  % if
      ...
      component.AppNameUI = bev1mus.AppUtil.Component.Label(component.base_grid);
      ...
      component.SourceLinkUI = bev1mus.AppUtil.Component.Hyperlink(component.base_grid);
      ...
      component.AlwaysOnTopUI = bev1mus.AppUtil.Component.CheckBox(component.base_grid);
    ...
    function regular_update(component)
      ...
      if component.Reporting
        ...
        bev1mus.FileUtil.displayTimeAndFileLocation("component.AppName: " + component.AppName)
      end  % if

      % AppName can be defined by the user, first as the Name property of bev1mus.AppUtil.AppWindow.
      % Then it is passed to the AppName property of this class.
      % Because bev1mus.AppUtil.AppWindow class is a regular MATLAB class, not a child class of
    ...
    function first_update(component)
      ...
      if not(component.UseCheckBoxForAlwaysOnTop)
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("not creating always-on-top check box")
        end  % if
        checkbox_ui_width = 0;
        ...
        if isempty(component.MainFigure)
          ...
          component.AlwaysOnTopUI.MainCheckBox.Tooltip = bev1mus.CodeUtil.i18n("Main figure is not defined.");
        else
  ...
  methods
    ...
    function valid = check_AlwaysOnTopUI_IsValid(component)
      ...
      if not(isvalid(component.AlwaysOnTopUI))
        % ignore
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("invalid because always-on-top check box was not created")
        end  % if
        valid = false;
      ...
      if isempty(component.MainFigure)
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("invalid because MainFigure is empty")
        end  % if
        valid = false;
    ...
    function configureWindowStyle(component, alwasy_on_top)
      ...
      if alwasy_on_top
        ...
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("MainFigure.WindowStyle: alwaysontop")
        end  % if
      else
        component.MainFigure.WindowStyle = "normal";
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("MainFigure.WindowStyle: normal")
        end  % if
      end  % if
    end  % function

classdef DropDown < bev1mus.AppUtil.Component.ComponentBase
  % Drop down component
  %
  ...
  properties
    ...
    DropDownWidth (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    ...
    DropDownHeight (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = bev1mus.AppUtil.Constant.Height{"oneline+"}

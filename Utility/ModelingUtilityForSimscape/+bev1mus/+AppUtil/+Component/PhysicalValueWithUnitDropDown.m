classdef PhysicalValueWithUnitDropDown < bev1mus.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    physical_value bev1mus.CodeUtil.PhysicalValue
  ...
  properties
    ...
    UnitUIWidth (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 10
    ...
    UnitDropDownUI bev1mus.AppUtil.Component.PhysicalUnitDropDown
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.physical_value = bev1mus.CodeUtil.PhysicalValue;
      ...
      component.NameUI.Text = bev1mus.CodeUtil.i18n("Physical value");
      ...
      component.UnitDropDownUI = bev1mus.AppUtil.Component.PhysicalUnitDropDown(component.unit_layout);
  ...
  methods
    ...
    function set.SimscapeValue(component, x)
      ...
      component.ValueText = bev1mus.CodeUtil.stringify(value(x));
  ...
  methods
    ...
    function updateInfoAndUnitUIs(component)
      ...
      squashed_value_text = bev1mus.CodeUtil.squashCodeText(bev1mus.CodeUtil.stringify(value(sscval)));
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      try
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("2:UnitDropDownUI.UnitItems")
        end  % if
        component.UnitDropDownUI.UnitItems = NewUnitItems;        
      catch exception
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("3:exception:" + exception.message)
        end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      if not(component.initialized)
        ...
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("2:reset")
        end  % if
        component.physical_value.initialized = false;
      end  % if
      try
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("3:UnitDropDownUI.UnitText:" + NewUnitText)
        end  % if
        component.UnitDropDownUI.UnitText = NewUnitText;
      catch exception
        if component.Reporting
          bev1mus.FileUtil.displayTimeAndFileLocation("5:exception:" + exception.message)
        end  % if
      ...
      if component.Reporting
        bev1mus.FileUtil.displayTimeAndFileLocation("6")
      end  % if
      component.AlertUI.MainImage.Visible = "off";
      component.AlertUI.MainImage.Tooltip = "";

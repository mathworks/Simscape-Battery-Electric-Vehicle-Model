classdef BaseWorkspaceStructParameterUI < bev1mus.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    GetParametersFromBaseWorkspaceCallback (:,1) {bev1mus.CodeUtil.mustBeFunctionHandleOrEmpty}
    ...
    ParameterFileTextUI bev1mus.AppUtil.Component.Label
    ParameterFileDropDownUI bev1mus.AppUtil.Component.DropDown
    SelecFileButtonUI bev1mus.AppUtil.Component.Button
    EditFileButtonUI bev1mus.AppUtil.Component.Button

    % For the "Variable name" row
    StructNameRow matlab.ui.container.GridLayout
    StructNameTextUI bev1mus.AppUtil.Component.Label
    StructNameDropDownUI bev1mus.AppUtil.Component.DropDown
    GetParametersFromBaseWorkspaceUI bev1mus.AppUtil.Component.Button
    OpenVariablesEditorButtonUI bev1mus.AppUtil.Component.Button
  ...
  methods
    ...
    function callback_select_and_load_parameter_file(component, NameValuePair)
      ...
      if NameValuePair.ParameterFileFullPath ~= ""
        ...
        if not(isfile(component.ParameterFileFullPath))
          ...
          msg = bev1mus.CodeUtil.i18n("Invalid file was specified: ") + NameValuePair.ParameterFileFullPath;
      ...
      if component.Reporting
        bev1mus.FileUtil.displayTimeAndFileLocation("FileDropDownUI.Value: " + component.ParameterFileDropDownUI.Value)
      end  % if
    end  % function
    ...
    function set.ParameterFileFullPath(component, ParameterFilePath)
      ...
      if not(isfile(ParameterFilePath))
        ...
        msg = bev1mus.CodeUtil.i18n("Invalid parameter file: ") + ParameterFilePath;
    ...
    function callback_change_structname_dropdown(component)
      ...
      try
        ...
        msg = bev1mus.CodeUtil.i18n("Evaluation failed: ") + selected_struct_name + newline + exception.message;
      ...
      if component.Reporting
        bev1mus.FileUtil.displayTimeAndFileLocation("2")
      end  % if
    end  % function
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.ParameterFileTextUI = bev1mus.AppUtil.Component.Label(component.ParameterFileRow);
      component.ParameterFileTextUI.Layout.Row = 1;
      component.ParameterFileTextUI.Layout.Column = 1;
      component.ParameterFileTextUI.Text = bev1mus.CodeUtil.i18n("Parameter file");
      component.ParameterFileTextUI.ComponentWidth = component.NameUIWidth;

      component.ParameterFileDropDownUI = bev1mus.AppUtil.Component.DropDown(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI = bev1mus.AppUtil.Component.Button(component.ParameterFileRow);
      ...
      component.SelecFileButtonUI.Text = bev1mus.CodeUtil.i18n("Select file...");
      ...
      component.SelecFileButtonUI.MainButton.Tooltip = ...
        bev1mus.CodeUtil.i18n("Select an M file containing parameters in a struct. The file is evaluated when selected.");

      component.EditFileButtonUI = bev1mus.AppUtil.Component.Button(component.ParameterFileRow);
      ...
      component.EditFileButtonUI.Text = bev1mus.CodeUtil.i18n("Edit");
      component.EditFileButtonUI.MainButton.Enable = "off";
      component.EditFileButtonUI.ButtonPushedCallback = @() edit(replace(component.ParameterFileDropDownUI.Value, " > ", filesep));
      component.EditFileButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Edit the selected file.");
      ...
      component.StructNameTextUI = bev1mus.AppUtil.Component.Label(component.StructNameRow);
      ...
      component.StructNameTextUI.Text = bev1mus.CodeUtil.i18n("Variable name");

      component.StructNameDropDownUI = bev1mus.AppUtil.Component.DropDown(component.StructNameRow);
      ...
      component.StructNameDropDownUI.MainDropDown.Tooltip = ...
        bev1mus.CodeUtil.i18n("Specify a struct or a class object in the base workspace." + ...
        " To load a struct or a class object, the struct fields or the class properties must match the app's definitions.");

      component.GetParametersFromBaseWorkspaceUI = bev1mus.AppUtil.Component.Button(component.StructNameRow);
      ...
      component.GetParametersFromBaseWorkspaceUI.Text = bev1mus.CodeUtil.i18n("Get");
      ...
      component.GetParametersFromBaseWorkspaceUI.MainButton.Tooltip = ...
        bev1mus.CodeUtil.i18n("Get parameters from the specified struct in the base workspace and load to the app.");

      component.OpenVariablesEditorButtonUI = bev1mus.AppUtil.Component.Button(component.StructNameRow);
      ...
      component.OpenVariablesEditorButtonUI.Text = bev1mus.CodeUtil.i18n("Open");
      component.OpenVariablesEditorButtonUI.MainButton.Enable = "off";
      component.OpenVariablesEditorButtonUI.ButtonPushedCallback = @() openvar(component.StructNameDropDownUI.Value);
      component.OpenVariablesEditorButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Open the Variables Editor.");

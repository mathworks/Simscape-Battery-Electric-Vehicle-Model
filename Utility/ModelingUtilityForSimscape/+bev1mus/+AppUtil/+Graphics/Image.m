classdef Image < bev1mus.AppUtil.Component.ComponentBase
  % Image component
  %
  ...
  properties
    ...
    ImageClickedCallback {bev1mus.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    ImageWidth (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = 18
    ...
    ImageHeight (1,:) {bev1mus.CodeUtil.mustBeTextOrPositiveNumber} = 18

...
if ModelName == ""
  ...
  msg = bev1mus.CodeUtil.i18n("Model name must be specified.");
...
if SimscapeBlockNames == ""
  ...
  msg = bev1mus.CodeUtil.i18n("Simscape block name must be specified.");

  throw(MException(id, msg))

end  % if

blocks_table = bev1mus.ModelUtil.findAllSimscapeBlocks(ModelName);

if isempty(blocks_table)
  id = errorID + "SimscapeBlockNotFound";
  msg = bev1mus.CodeUtil.i18n("Specified model does not have any Simscape blocks.");

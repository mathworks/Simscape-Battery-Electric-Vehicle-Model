classdef TestResultAppMain < handle
  ...
  properties
    ...
    SelectFileButtonUI bev1mus.AppUtil.Component.Button
    OpenInEditorButtonUI bev1mus.AppUtil.Component.Button
    TestResultFileDropDownUI bev1mus.AppUtil.Component.DropDown

    NumTestsUI bev1mus.AppUtil.Component.Label
    TotalTimeUI bev1mus.AppUtil.Component.Label
    MeanTimeUI bev1mus.AppUtil.Component.Label
    MedianTimeUI bev1mus.AppUtil.Component.Label

    NumErrorsUI bev1mus.AppUtil.Component.Label

    RefreshButtonUI bev1mus.AppUtil.Component.Button

    ResultTableUI bev1mus.AppUtil.Component.Table

    MessageUI bev1mus.AppUtil.Component.Label
  end  % properties

  properties (Constant, Access=private)
    width_button = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 12
    style_for_error = uistyle(BackgroundColor = "yellow")
    default_message = bev1mus.CodeUtil.i18n("Double-click a table row to open the file. (The file must exist.)")
  end  % properties
  ...
  methods
    ...
    function App = TestResultAppMain(NameValuePair)
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("Test result");
      ...
      elseif isfile(NameValuePair.TestResultFileName)
        ...
        msg = bev1mus.CodeUtil.i18n("Invalid file: ") + NameValuePair.TestResultFileName;
    ...
    function build_app_gui(App)
      ...
      label_ui.ComponentWidth = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 14;
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Test result file") + "}";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.SelectFileButtonUI = bev1mus.AppUtil.Component.Button(row_grid);
      App.SelectFileButtonUI.ButtonWidth = App.width_button;
      App.SelectFileButtonUI.Text = bev1mus.CodeUtil.i18n("Select...");
      App.SelectFileButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Select a test result file.");
      App.SelectFileButtonUI.ButtonPushedCallback = @() react_SelectResultFileButtonPushed(App);

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.OpenInEditorButtonUI = bev1mus.AppUtil.Component.Button(row_grid);
      App.OpenInEditorButtonUI.ButtonWidth = App.width_button;
      App.OpenInEditorButtonUI.Text = bev1mus.CodeUtil.i18n("Open in editor");
      App.OpenInEditorButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Open the test result file in the editor.");
      ...
      App.TestResultFileDropDownUI = bev1mus.AppUtil.Component.DropDown(column_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = bev1mus.AppUtil.Component.Label(row_grid);
      label_ui.Text = bev1mus.CodeUtil.i18n("Number of tests");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.NumTestsUI = bev1mus.AppUtil.Component.Label(row_grid);
      App.NumTestsUI.Text = "";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = bev1mus.AppUtil.Component.Label(row_grid);
      label_ui.Text = bev1mus.CodeUtil.i18n("Total test time (s)");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.TotalTimeUI = bev1mus.AppUtil.Component.Label(row_grid);
      App.TotalTimeUI.Text = "";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = bev1mus.AppUtil.Component.Label(row_grid);
      label_ui.Text = bev1mus.CodeUtil.i18n("Mean test time (s)");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.MeanTimeUI = bev1mus.AppUtil.Component.Label(row_grid);
      App.MeanTimeUI.Text = "";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = bev1mus.AppUtil.Component.Label(row_grid);
      label_ui.Text = bev1mus.CodeUtil.i18n("Median test time (s)");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.MedianTimeUI = bev1mus.AppUtil.Component.Label(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      label_ui = bev1mus.AppUtil.Component.Label(row_grid);
      label_ui.Text = bev1mus.CodeUtil.i18n("Number of failures");
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.NumErrorsUI = bev1mus.AppUtil.Component.Label(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.RefreshButtonUI = bev1mus.AppUtil.Component.Button(row_grid);
      ...
      App.ResultTableUI = bev1mus.AppUtil.Component.Table(column_grid);
      ...
      App.MessageUI = bev1mus.AppUtil.Component.Label(column_grid);
      App.MessageUI.Text = bev1mus.CodeUtil.i18n("Double-click a table row to open the file.");
    ...
    function react_ResultFileNameDropDownChanged(App)
      ...
      if new_styled_path == ""
        ...
        if not(isfile(raw_path))
          msg = bev1mus.CodeUtil.i18n("Invalid file: " + raw_path);
          if App.GUIReady
    ...
    function react_TableRowDoubleClicked(App, row_number)
      ...
      targetfile_fullpath = bev1mus.FileUtil.getFileFullPath(targetfile_filename, ReturnIfNotFound=true);

      if targetfile_fullpath == ""
        App.MessageUI.Text = bev1mus.CodeUtil.i18n("File not found.");
    ...
    function update_ui(App)
      result_table = bev1mus.TestUtil.getTestResultTable(App.TestResultFile);

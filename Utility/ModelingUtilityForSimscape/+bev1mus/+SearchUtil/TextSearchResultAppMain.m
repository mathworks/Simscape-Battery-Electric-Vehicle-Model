classdef TextSearchResultAppMain < handle
  ...
  properties
    TextSearcher (1,1) bev1mus.SearchUtil.TextSearcher
    SearchResult table
    ...
    CopyReplaceCommandTextUI bev1mus.AppUtil.Component.Button
    NewTextUI bev1mus.AppUtil.Component.DropDown
  ...
  methods
    ...
    function App = TextSearchResultAppMain(Searcher, NameValuePair)
      ...
      arguments (Input)
        Searcher (1,1) bev1mus.SearchUtil.TextSearcher = bev1mus.SearchUtil.TextSearcher(Initialization="default")
      ...
      if not(ready(Searcher))
        ...
        msg = bev1mus.CodeUtil.i18n("TextSearcher must be initialized.");
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("Text search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Open the text search app.");
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("Searched text");
      ...
      indent_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      indent_ui.ComponentWidth = App.width_name_ui;
      indent_ui.Text = "";

      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container));
      if App.TextSearcher.States.IgnoreCase
        label_ui.Text = bev1mus.CodeUtil.i18n("Case ignored");
      else
        label_ui.Text = bev1mus.CodeUtil.i18n("Case sensitive");
      end  % if
      ...
      if App.TextSearcher.States.MatchWholeWord
        label_ui.Text = bev1mus.CodeUtil.i18n("Match whole word");
      else
        label_ui.Text = bev1mus.CodeUtil.i18n("Match anywhere");
      end  % if
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("File types");
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("Folder");
      ...
      if App.TextSearcher.States.IncludeSubfolders
        label_ui.Text = bev1mus.CodeUtil.i18n("Including subfolders");
      else
        label_ui.Text = bev1mus.CodeUtil.i18n("Excluding subfolders");
      end
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Replace") + "}";

      App.CopyReplaceCommandTextUI = bev1mus.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
      App.CopyReplaceCommandTextUI.ButtonWidth = App.width_button;
      App.CopyReplaceCommandTextUI.HorizontalAlignment = "right";
      App.CopyReplaceCommandTextUI.Text = bev1mus.CodeUtil.i18n("Copy command");
      App.CopyReplaceCommandTextUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Copy the replace command to clipboard.");
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("New text");

      App.NewTextUI = bev1mus.AppUtil.Component.DropDown(addHorizontalGridLayout(h_container));
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("Number of matched lines");
      ...
      button_ui = bev1mus.AppUtil.Component.Button(addHorizontalGridLayout(h_container, Width="fit"));
      button_ui.ButtonWidth = App.width_button;
      button_ui.Text = bev1mus.CodeUtil.i18n("Refresh");
      button_ui.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Rerun search and update the result table.");
      button_ui.ButtonPushedCallback = @() react_RefreshButtonPushed(App);

      % -----------------------------------------------------------------------
      v_layout = addVerticalGridLayout(main_v_container);
      label_ui = bev1mus.AppUtil.Component.Label(v_layout);
      label_ui.Text = bev1mus.CodeUtil.i18n("Double-click a table row to open the file.");
      ...
      App.TableUI.MainTable.ColumnName = [bev1mus.CodeUtil.i18n("File path"), bev1mus.CodeUtil.i18n("Line number"), bev1mus.CodeUtil.i18n("Line text")];
    ...
    function react_NewSearch(App)
      bev1mus.SearchUtil.TextSearchAppMain(StatesSource="external", SearchStates=App.TextSearcher.States)
    end  % function
    ...
    function react_CopyReplaceCommandButtonPushed(App)
      ...
      %   result = bev1mus.SearchUtil.replaceText(file_paths, DryRun=true, TextPattern="old", NewText="new");
      ...
      assert(iscolumn(file_paths), App.errorID+"InternalError", bev1mus.CodeUtil.i18n("Internal error"))
      assert(all(isfile(file_paths)), App.errorID+"InternalError", bev1mus.CodeUtil.i18n("Internal error"))

      code_lines = bev1mus.SearchUtil.buildReplaceCommandText( ...

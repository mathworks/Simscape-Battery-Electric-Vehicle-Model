classdef FileSearchResultAppMain < handle
  ...
  methods
    ...
    function App = FileSearchResultAppMain(NameValuePair)
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("File search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI = bev1mus.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container));
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = bev1mus.CodeUtil.i18n("Open the file search app.");
      ...
      label_ui = bev1mus.AppUtil.Component.Label(addHorizontalGridLayout(horizontal_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bev1mus.CodeUtil.i18n("Searched file name");

      editfield_ui = bev1mus.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container));
      ...
      App.NumMatchesUI = bev1mus.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container, Width="1x"));
      ...
      App.RefreshButtonUI = bev1mus.AppUtil.Component.Button(addHorizontalGridLayout(horizontal_container, Width="fit"));
      ...
      App.TableUI = bev1mus.AppUtil.Component.Table(column_grid);
      App.TableUI.ComponentHeight = "fit";
      if App.SearchResult ~= ""
        App.TableUI.MainTable.Data = table(App.SearchResult);
        App.TableUI.MainTable.ColumnName = bev1mus.CodeUtil.i18n("File path");
    ...
    function react_NewSearch(App)
      if App.TopFolder ~= "" && App.SearchFileName ~= ""
        bev1mus.SearchUtil.FileSearchAppMain(TopFolder=App.TopFolder, SearchFileName=App.SearchFileName)
      else
        bev1mus.SearchUtil.FileSearchAppMain
      end  % if
    end  % function

    function react_RefreshButtonPushed(App)
      FilePath = bev1mus.SearchUtil.searchFiles(App.SearchFileName, TopFolder=App.TopFolder);

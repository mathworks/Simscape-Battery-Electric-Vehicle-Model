classdef FileSearchAppMain < handle
  ...
  properties
    ...
    SearchFileNameUI bev1mus.AppUtil.Component.DropDown
  ...
  methods
    ...
    function App = FileSearchAppMain(NameValuePair)
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("File search");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("File name to search") + "}";

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);

      App.SearchFileNameUI = bev1mus.AppUtil.Component.DropDown(column_grid);
      ...
      App.TopFolderUI = bev1mus.AppUtil.Component.DropDown(column_grid);
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if App.SearchFileNameUI.Value == ""
        ...
        App.CommandText = "bev1mus.SearchUtil.searchFiles(""" + App.SearchFileNameUI.Value + """, TopFolder=""" + top_folder + """)";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      top_folder = replace(App.TopFolderUI.Value, " > ", filesep);
      App.SearchResult = bev1mus.SearchUtil.searchFiles(App.SearchFileNameUI.Value, TopFolder=top_folder);

      if isempty(App.SearchResult)
        uialert(App.Window.MainFigure, bev1mus.CodeUtil.i18n("File was not found."), bev1mus.CodeUtil.i18n("Not found"))

        return

      end  % if

      bev1mus.SearchUtil.FileSearchResultAppMain( ...

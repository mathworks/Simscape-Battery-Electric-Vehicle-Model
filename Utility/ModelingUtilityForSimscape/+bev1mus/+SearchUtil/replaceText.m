...
if num_files == 0
  ...
  msg = bev1mus.CodeUtil.i18n("One or more files must be specified.");
...
if not(isfield(NameValuePair, "TextPattern"))
  ...
  msg = bev1mus.CodeUtil.i18n("Text pattern must be specified.");
...
if not(isfield(NameValuePair, "NewText"))
  ...
  msg = bev1mus.CodeUtil.i18n("New text must be specified.");

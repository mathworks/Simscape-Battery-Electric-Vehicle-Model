...
if not(isstring(x))
  ...
  msg = bev1mus.CodeUtil.i18n("Value must be a string.");
...
msg = bev1mus.CodeUtil.i18n("Value must be convertible to either a real scalar, a variable, or a struct field.");

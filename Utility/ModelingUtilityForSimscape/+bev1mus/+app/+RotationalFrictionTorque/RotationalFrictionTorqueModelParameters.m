classdef RotationalFrictionTorqueModelParameters
  ...
  properties
    ...
    BreakawayTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayTorque, "N*m"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")

    BreakawayVelocity (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(BreakawayVelocity, "rad/s"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "rad/s")

    CoulombTorque (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(CoulombTorque, "N*m"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N*m")

    ViscousCoefficient (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(ViscousCoefficient, "N*m*s/rad"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...

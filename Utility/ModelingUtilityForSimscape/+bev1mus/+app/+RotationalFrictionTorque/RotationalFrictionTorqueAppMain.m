classdef RotationalFrictionTorqueAppMain < handle
  ...
  properties
    ...
    DataSet (1,1) bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet
    ...
    DocLinkUI bev1mus.AppUtil.Component.Hyperlink

    BreakawayTorqueUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    BreakawayVelocityUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    CoulombTorqueUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    ViscousCoefficientUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown

    StribeckScaledTorqueUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    StribeckThresholdVelocityUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    CoulombThresholdVelocityUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    ...
    ShowStribeckTorqueUI bev1mus.AppUtil.Component.CheckBox
    ShowCoulombTorqueUI bev1mus.AppUtil.Component.CheckBox
    ShowViscousTorqueUI bev1mus.AppUtil.Component.CheckBox

    PlotAngularVelocityUnitUI bev1mus.AppUtil.Component.PhysicalUnitDropDown
    PlotTorqueUnitUI bev1mus.AppUtil.Component.PhysicalUnitDropDown
  ...
  methods
    ...
    function App = RotationalFrictionTorqueAppMain(NameValuePair)
      ...
      App.DataSet = bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet(Initialization=true);
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("Rotational Friction Torque");
      ...
      if NameValuePair.AppParameterFileName ~= ""
        ...
        if NameValuePair.AppParameterStructName == ""
          ...
          msg = bev1mus.CodeUtil.i18n("AppParameterStructName is required when AppParameterFileName is specified.");
    ...
    function build_app_gui(App)
      ...
      description_link_ui.HyperlinkClickedCallback = @() web("RotationalFrictionTorqueApp_Description_bev1mus.html");

      % -----------------------------------------------------------------------
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);

      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.ComponentHeight = bev1mus.AppUtil.Constant.Height{"oneline"} * 4;
      label_ui.Text = join([
      ...
      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.ComponentHeight = bev1mus.AppUtil.Constant.Height{"oneline"} * 2 + 10;
      label_ui.Text = join( [
        "$"
      ...
      label_ui.Text = bev1mus.CodeUtil.i18n("Rotational Friction block:");
      label_ui.ComponentWidth = App.width_unit * 19;

      h_layout = addHorizontalGridLayout(h_container, Width="fit");
      App.DocLinkUI = bev1mus.AppUtil.Component.Hyperlink(h_layout);
      App.DocLinkUI.Text = bev1mus.CodeUtil.i18n("Documentation");
      ...
      ssc_link_ui = bev1mus.AppUtil.Component.Hyperlink(h_layout);
      ssc_link_ui.Text = bev1mus.CodeUtil.i18n("Simscape source");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.Text = "\bf{" + bev1mus.CodeUtil.i18n("Parameters") + "}";

      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.BreakawayTorqueUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      App.BreakawayTorqueUI.Editable = "on";
      App.BreakawayTorqueUI.NameText = bev1mus.CodeUtil.i18n("Breakaway friction torque, $T_{B}$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.BreakawayVelocityUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      App.BreakawayVelocityUI.Editable = "on";
      App.BreakawayVelocityUI.NameText = bev1mus.CodeUtil.i18n("Breakaway friction velocity, $\omega_{B}$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.CoulombTorqueUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      App.CoulombTorqueUI.Editable = "on";
      App.CoulombTorqueUI.NameText = bev1mus.CodeUtil.i18n("Coulomb friction torque, $T_{C}$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.ViscousCoefficientUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      App.ViscousCoefficientUI.Editable = "on";
      App.ViscousCoefficientUI.NameText = bev1mus.CodeUtil.i18n("Viscous friction coefficient, $f$");
      ...
      component_height = bev1mus.AppUtil.Constant.Height{"oneline++"} * 2;

      name_ui_width = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 26;

      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.StribeckScaledTorqueUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      ...
      App.StribeckScaledTorqueUI.NameText = ...
        bev1mus.CodeUtil.i18n("Scale factor for Stribeck torque") + newline + "$T_{S} = \sqrt{2e} (T_{B} - T_{C})$";

      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.StribeckThresholdVelocityUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      ...
      App.StribeckThresholdVelocityUI.NameText = ...
        bev1mus.CodeUtil.i18n("Velocity threshold for Stribeck torque") + newline + "$\omega_{S} = \omega_{B} \sqrt{2}$";

      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      App.CoulombThresholdVelocityUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      ...
      App.CoulombThresholdVelocityUI.NameText = ...
        bev1mus.CodeUtil.i18n("Velocity threshold for Coulomb torque") + newline + "$\omega_{C} = \omega_{B} / 10$";
      ...
      function open_in_figure_window
        bev1mus.app.RotationalFrictionTorque.plotRotationalFrictionTorque( ...
      ...
      h_layout = addHorizontalGridLayout(h_container, Width=(bev1mus.AppUtil.Constant.Width{"unitwidth"} * 18));
      label_ui = bev1mus.AppUtil.Component.Label(h_layout);
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Torque components") + "}";
      label_ui.HorizontalAlignment = "center";

      h_layout = addHorizontalGridLayout(h_container);
      App.ShowStribeckTorqueUI = bev1mus.AppUtil.Component.CheckBox(h_layout);
      App.ShowStribeckTorqueUI.Text = bev1mus.CodeUtil.i18n("Stribeck");
      App.ShowStribeckTorqueUI.ValueChangedCallback = @() updateApp(App);

      h_layout = addHorizontalGridLayout(h_container);
      App.ShowCoulombTorqueUI = bev1mus.AppUtil.Component.CheckBox(h_layout);
      App.ShowCoulombTorqueUI.Text = bev1mus.CodeUtil.i18n("Coulomb");
      App.ShowCoulombTorqueUI.ValueChangedCallback = @() updateApp(App);

      h_layout = addHorizontalGridLayout(h_container);
      App.ShowViscousTorqueUI = bev1mus.AppUtil.Component.CheckBox(h_layout);
      App.ShowViscousTorqueUI.Text = bev1mus.CodeUtil.i18n("Viscous");
      ...
      addHorizontalGridLayout(h_container, Width=(bev1mus.AppUtil.Constant.Width{"unitwidth"} * 2));

      h_layout = addHorizontalGridLayout(h_container);
      label1_ui = bev1mus.AppUtil.Component.Label(h_layout);
      label1_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Plot unit") + "}";
      label1_ui.ComponentWidth = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 7;
      label1_ui.HorizontalAlignment = "center";

      h_layout = addHorizontalGridLayout(h_container);
      label2_ui = bev1mus.AppUtil.Component.Label(h_layout);
      label2_ui.Text = bev1mus.CodeUtil.i18n("Angular velocity");
      % label2_ui.ComponentWidth = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 12;
      % label_ui.HorizontalAlignment = "right";

      h_layout = addHorizontalGridLayout(h_container);
      App.PlotAngularVelocityUnitUI = bev1mus.AppUtil.Component.PhysicalUnitDropDown(h_layout);
      ...
      % label2_ui.ComponentWidth = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 7;

      h_layout = addHorizontalGridLayout(h_container);
      App.PlotTorqueUnitUI = bev1mus.AppUtil.Component.PhysicalUnitDropDown(h_layout);
    ...
    function callback_get_parameters(App)
      ...
      try
        App.DataSet = bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet(BlockPath=App.BlockPath);
      catch exception
      ...
      if not(App.MainFigure.Visible)
        ...
        data_set = bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet(Initialization=true);

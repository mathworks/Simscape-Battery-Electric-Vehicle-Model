classdef RotationalFrictionTorqueDataSet
  ...
  properties
    ...
    ModelParams (1,1) bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueModelParameters
  ...
  methods
    ...
    function DataSet = RotationalFrictionTorqueDataSet(NameValuePair)
      ...
      DataSet.ModelParams = bev1mus.app.RotationalFrictionTorque.RotationalFrictionTorqueModelParameters;
      ...
      if DataSet.ModelName == ""
        ...
        DataSet.ModelParams.BreakawayTorque = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "brkwy_trq");
        DataSet.ModelParams.BreakawayVelocity = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "brkwy_vel");
        DataSet.ModelParams.CoulombTorque = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "Col_trq");
        DataSet.ModelParams.ViscousCoefficient = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "visc_coef");

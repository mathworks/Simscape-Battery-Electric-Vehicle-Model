classdef Vehicle1DForceDataSet
  ...
  properties
    ...
    ModelParams (1,1) bev1mus.app.Vehicle1DForce.Vehicle1DForceModelParameters
    ...
    PlotGrades (1,:) double { bev1mus.CodeUtil.mustBeNonnegativeOrNan } = [nan, nan]
  ...
  methods
    ...
    function DataSet = Vehicle1DForceDataSet(NameValuePair)
      ...
      DataSet.ModelParams = bev1mus.app.Vehicle1DForce.Vehicle1DForceModelParameters;
      ...
      if DataSet.ModelName == ""
        ...
        if veh_type ~= string(sdl.enum.VehicleParameterizationType.Regular) ...
          ...
          msg = bev1mus.CodeUtil.i18n("Parameterization type must be Regular parameter set.");

          throw(MException(id, msg))

        end  % if

        DataSet.ModelParams.VehicleMass = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "M_vehicle");
        DataSet.ModelParams.TireRollingCoefficient = bev1mus.ModelUtil.getDoubleValueFromBlockParameter(DataSet.BlockPath, "C_tireroll");
        DataSet.ModelParams.AirDragCoefficient = bev1mus.ModelUtil.getDoubleValueFromBlockParameter(DataSet.BlockPath, "C_airdrag");
        DataSet.ModelParams.FrontalArea = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "A_front");
        DataSet.ModelParams.GravitationalAcceleration = bev1mus.ModelUtil.getSimscapeValueFromBlockParameter(DataSet.BlockPath, "g");

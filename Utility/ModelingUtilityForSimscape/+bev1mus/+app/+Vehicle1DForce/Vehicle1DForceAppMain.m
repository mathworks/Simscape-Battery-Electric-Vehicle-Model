classdef Vehicle1DForceAppMain < handle
  ...
  properties
    ...
    DataSet (1,1) bev1mus.app.Vehicle1DForce.Vehicle1DForceDataSet
    ...
    LeftSideWidth (1,1) {bev1mus.CodeUtil.mustBeStringOrPositiveInteger} = "1x"
    RightSideWidth (1,1) {bev1mus.CodeUtil.mustBeStringOrPositiveInteger} = "1x"
    ...
    PresetDropDownUI bev1mus.AppUtil.Component.DropDown

    % === Vehicle

    VehicleMassUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    TireRollingCoefficientUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    AirDragCoefficientUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    FrontalAreaUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown

    % === Environment

    GravitationalAccelerationUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    DryAirDensityUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel

    % === Road-load coefficient

    RoadLoadBUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel

    % === Performance

    TopSpeedUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    MaxClimbGradePercentUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    MaxAccelerationUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel

    % === Derived parameters

    RoadLoadAUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    RoadLoadCUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    MaxForceUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    MaxClimbPowerUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    MaxClimbPowerPSUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    MaxClimbPowerBHPUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    ...
    PlotSpeedUpperBoundUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    PlotForceUpperBoundUI bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown
    PlotGradesUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
    PlotPowersUI bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 20
    unit_ui_width = bev1mus.AppUtil.Constant.Width{"unitwidth"} * 12
  ...
  properties (Access=private)
    presets (1,1) bev1mus.app.Vehicle1DForce.Vehicle1DForcePresets
  end  % properties
  ...
  methods
    ...
    function App = Vehicle1DForceAppMain(NameValuePair)
      ...
      App.presets = bev1mus.app.Vehicle1DForce.Vehicle1DForcePresets;
      App.DataSet = bev1mus.app.Vehicle1DForce.Vehicle1DForceDataSet(Initialization=true);
      ...
      App.Window.Name = bev1mus.CodeUtil.i18n("Vehicle 1D Force");
      ...
      if App.BlockPath ~= ""
        ...
        data_set = bev1mus.app.Vehicle1DForce.Vehicle1DForceDataSet(Initialization=true);
    ...
    function build_app_gui(App)
      ...
      description_link_ui = bev1mus.AppUtil.Component.Hyperlink(appleft_v_layout);
      description_link_ui.Text = bev1mus.CodeUtil.i18n("Description");
      description_link_ui.HyperlinkClickedCallback = @() web("Vehicle1DForceApp_Description_bev1mus.html");
      ...
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Preset") + "}";

      h_layout = addHorizontalGridLayout(h_container);
      App.PresetDropDownUI = bev1mus.AppUtil.Component.DropDown(h_layout);
      ...
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Vehicle") + "}";

      % -----------------------------------------------------------------------
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);

      App.VehicleMassUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      ...
      App.VehicleMassUI.NameText = bev1mus.CodeUtil.i18n("Vehicle mass, $M_v$");
      ...
      App.TireRollingCoefficientUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.TireRollingCoefficientUI.NameUIWidth = App.name_ui_width;
      App.TireRollingCoefficientUI.UnitUIWidth = App.unit_ui_width;
      App.TireRollingCoefficientUI.NameText = bev1mus.CodeUtil.i18n("Tire rolling coefficient, $C_{roll}$");
      ...
      App.AirDragCoefficientUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.AirDragCoefficientUI.NameUIWidth = App.name_ui_width;
      App.AirDragCoefficientUI.UnitUIWidth = App.unit_ui_width;
      App.AirDragCoefficientUI.NameText = bev1mus.CodeUtil.i18n("Air drag coefficient, $C_d$");
      ...
      App.FrontalAreaUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      ...
      App.FrontalAreaUI.NameText = bev1mus.CodeUtil.i18n("Frontal area, $A_f$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Environment") + "}";

      % -----------------------------------------------------------------------
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);

      App.GravitationalAccelerationUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      ...
      App.GravitationalAccelerationUI.NameText = bev1mus.CodeUtil.i18n("Gravitational acceleration, $g$");
      ...
      App.DryAirDensityUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.DryAirDensityUI.NameUIWidth = App.name_ui_width;
      App.DryAirDensityUI.UnitUIWidth = App.unit_ui_width;
      App.DryAirDensityUI.NameText = bev1mus.CodeUtil.i18n("Dry air density, $\rho$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Road-load coefficient") + "}";

      % -----------------------------------------------------------------------
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);

      App.RoadLoadBUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.RoadLoadBUI.NameUIWidth = App.name_ui_width;
      App.RoadLoadBUI.UnitUIWidth = App.unit_ui_width;
      App.RoadLoadBUI.NameText = bev1mus.CodeUtil.i18n("$B_{rl}$");
      ...
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);
      label_ui = bev1mus.AppUtil.Component.Label(appleft_v_layout);
      label_ui.Text = "\textbf{" + bev1mus.CodeUtil.i18n("Performance") + "}";

      % -----------------------------------------------------------------------
      appleft_v_layout = addVerticalGridLayout(appleft_v_container);

      App.TopSpeedUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appleft_v_layout);
      App.TopSpeedUI.Editable = "on";
      App.TopSpeedUI.NameUIWidth = App.name_ui_width;
      App.TopSpeedUI.UnitUIWidth = App.unit_ui_width;
      App.TopSpeedUI.NameText = bev1mus.CodeUtil.i18n("Top speed, $V_{max}$");
      ...
      App.MaxClimbGradePercentUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.MaxClimbGradePercentUI.NameUIWidth = App.name_ui_width;
      App.MaxClimbGradePercentUI.UnitUIWidth = App.unit_ui_width;
      App.MaxClimbGradePercentUI.NameText = bev1mus.CodeUtil.i18n("Max climb grade, $\beta_{max}$");
      ...
      App.MaxAccelerationUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.MaxAccelerationUI.NameUIWidth = App.name_ui_width;
      App.MaxAccelerationUI.UnitUIWidth = App.unit_ui_width;
      App.MaxAccelerationUI.NameText = bev1mus.CodeUtil.i18n("Max acceleration, $g_{max}$");
      ...
      App.MaxClimbPowerUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.MaxClimbPowerUI.NameUIWidth = App.name_ui_width;
      App.MaxClimbPowerUI.UnitUIWidth = App.unit_ui_width;
      App.MaxClimbPowerUI.NameText = bev1mus.CodeUtil.i18n("Climb power, $P_c$, at $V_{max}, \beta_{max}$");
      ...
      App.MaxClimbPowerBHPUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      ...
      App.MaxClimbPowerPSUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      ...
      App.MaxForceUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.MaxForceUI.NameUIWidth = App.name_ui_width;
      App.MaxForceUI.UnitUIWidth = App.unit_ui_width;
      App.MaxForceUI.NameText = bev1mus.CodeUtil.i18n("Max force, $F_{max} = g_{max} M_v g$");
      ...
      App.RoadLoadAUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.RoadLoadAUI.NameUIWidth = App.name_ui_width;
      App.RoadLoadAUI.UnitUIWidth = App.unit_ui_width;
      App.RoadLoadAUI.NameText = bev1mus.CodeUtil.i18n("$A_{rl} = C_{roll} M_v g$");
      ...
      App.RoadLoadCUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appleft_v_layout);
      App.RoadLoadCUI.NameUIWidth = App.name_ui_width;
      App.RoadLoadCUI.UnitUIWidth = App.unit_ui_width;
      App.RoadLoadCUI.NameText = bev1mus.CodeUtil.i18n("$C_{rl} = (1/2) C_d A_f \rho$");
      ...
      function open_in_figure_window
        bev1mus.app.Vehicle1DForce.plotVehicle1DForce( ...
      ...
      App.PlotSpeedUpperBoundUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appright_v_layout);
      ...
      App.PlotSpeedUpperBoundUI.NameText = bev1mus.CodeUtil.i18n("Speed upper bound");
      ...
      App.PlotForceUpperBoundUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitDropDown(appright_v_layout);
      ...
      App.PlotForceUpperBoundUI.NameText = bev1mus.CodeUtil.i18n("Force upper bound");
      ...
      App.PlotGradesUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appright_v_layout);
      App.PlotGradesUI.NameUIWidth = App.name_ui_width;
      App.PlotGradesUI.UnitUIWidth = App.unit_ui_width;
      App.PlotGradesUI.NameText = bev1mus.CodeUtil.i18n("Road grades");
      ...
      App.PlotPowersUI = bev1mus.AppUtil.Component.PhysicalValueWithUnitLabel(appright_v_layout);
      App.PlotPowersUI.NameUIWidth = App.name_ui_width;
      App.PlotPowersUI.UnitUIWidth = App.unit_ui_width;
      App.PlotPowersUI.NameText = bev1mus.CodeUtil.i18n("Constant power curves");
    ...
    function callback_get_parameters(App)
      ...
      try
        App.DataSet = bev1mus.app.Vehicle1DForce.Vehicle1DForceDataSet(BlockPath=App.BlockPath);
      catch exception

...
arguments (Input)
  ...
  NameValuePair.DataSet bev1mus.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet {mustBeScalarOrEmpty}
  ...
  NameValuePair.MaxTorque (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MaxTorque, "N*m"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(160, "N*m")

  NameValuePair.PlotTorqueUpperBound simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotTorqueUpperBound, "N*m"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.MaxAngularSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MaxAngularSpeed, "rad/s"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.PlotAngularSpeedUpperBound simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.PlotAngularSpeedUpperBound, "rad/s"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.MaxPower (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(NameValuePair.MaxPower, "kW"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
  ...
  NameValuePair.MeasuredAngularSpeed (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredAngularSpeed, "rpm"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(2000, "rpm")

  NameValuePair.MeasuredTorque (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredTorque, "N*m"), bev1mus.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    = simscape.Value(50, "N*m")

  NameValuePair.MeasuredIronLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.MeasuredIronLosses, "W"), bev1mus.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(55, "W")

  NameValuePair.FixedLosses (1,1) simscape.Value ...
    { simscape.mustBeCommensurateUnit(NameValuePair.FixedLosses, "W"), bev1mus.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
    = simscape.Value(40, "W")

  NameValuePair.RotorDamping (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(NameValuePair.RotorDamping, "N*m/rpm"), bev1mus.CodeUtil.mustBeSimscapeValueNonnegativeOrNan } ...
...
if NameValuePair.DataSource == "direct"
  ...
  if isfield(NameValuePair, "DataSet")
    ...
    DataSet = bev1mus.app.AbstractMotorEfficiency.AbstractMotorEfficiencyDataSet(Initialization=true);
  end  % if
...
xlabel(ax, bev1mus.CodeUtil.i18n("Angular speed, $\omega$ (" + plot_speed_unit_text + ")"), Interpreter="latex")

ylabel(ax, bev1mus.CodeUtil.i18n("Torque, $\tau$ (" + plot_torque_unit_text + ")"), Interpreter="latex")

title(ax, [
  bev1mus.CodeUtil.i18n("Overall power conversion efficiency (%)")
  bev1mus.CodeUtil.i18n("Measured point (x): ") ...

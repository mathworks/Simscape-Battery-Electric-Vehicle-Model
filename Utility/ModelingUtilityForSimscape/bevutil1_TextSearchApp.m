...
% Example:
%
%   bevutil1_TextSearchApp(TargetFolder=pwd, SearchText="hello", IgnoreCase=true)
%
...
%   bevutil1_TextSearchApp(StatesSource="external", SearchStates=states)
%
...
arguments (Output)
  App bevutil1.SearchUtil.TextSearchAppMain {mustBeScalarOrEmpty}
end  % arguments

switch NameValuePair.StatesSource

  case "options"
    app_main = bevutil1.SearchUtil.TextSearchAppMain( ...
      StatesSource = "options", ...

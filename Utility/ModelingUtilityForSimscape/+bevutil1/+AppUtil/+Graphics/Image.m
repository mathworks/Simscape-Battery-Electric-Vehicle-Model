classdef Image < bevutil1.AppUtil.Component.ComponentBase
  % Image component
  %
  ...
  properties
    ...
    ImageClickedCallback {bevutil1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = "1x"
    ImageWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = 18
    ...
    ImageHeight (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = 18

classdef EnabledButton < bevutil1.AppUtil.Component.ComponentBase
  ...
  properties
    ButtonPushedCallback {bevutil1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    CheckBoxValueChangedCallback {bevutil1.CodeUtil.mustBeFunctionHandleOrEmpty} = []
    ...
    ButtonUIWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = bevutil1.AppUtil.Constant.Width{"unitwidth"} * 11
    ...
    CheckBoxUIWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = "fit"
    CheckBoxWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = "fit"
    % There is no CheckBoxHeight property.
    % The height of the main check box is fixed by uicheckbox.

    ButtonUI bevutil1.AppUtil.Component.Button
    CheckBoxUI bevutil1.AppUtil.Component.CheckBox {mustBeScalarOrEmpty}
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      % -----------------------------------------------------------------------
      % Button
      component.ButtonUI = bevutil1.AppUtil.Component.Button(component.composite_grid);
      ...
      % -----------------------------------------------------------------------
      % Check box
      component.CheckBoxUI = bevutil1.AppUtil.Component.CheckBox(component.composite_grid);

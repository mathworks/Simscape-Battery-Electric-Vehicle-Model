classdef PhysicalValueWithUnitDropDown < bevutil1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    physical_value bevutil1.CodeUtil.PhysicalValue
  ...
  properties
    ...
    UnitDropDownUI bevutil1.AppUtil.Component.PhysicalUnitDropDown
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.UnitDropDownUI = bevutil1.AppUtil.Component.PhysicalUnitDropDown(component.unit_layout);
  ...
  methods
    ...
    function set.UnitItems(component, NewUnitItems)
      ...
      try
        if component.Reporting
          bevutil1.FileUtil.displayTimeAndFileLocation("2:UnitDropDownUI.UnitItems")
        end  % if
        component.UnitDropDownUI.UnitItems = NewUnitItems;        
      catch exception
        if component.Reporting
          bevutil1.FileUtil.displayTimeAndFileLocation("3:exception:" + exception.message)
        end  % if
    ...
    function set.UnitText(component, NewUnitText)
      ...
      try
        if component.Reporting
          bevutil1.FileUtil.displayTimeAndFileLocation("3:UnitDropDownUI.UnitText:" + NewUnitText)
        end  % if

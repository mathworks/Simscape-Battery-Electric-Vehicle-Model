classdef DoubleValueUI < bevutil1.AppUtil.Component.ComponentBase
  ...
  properties
    ...
    double_value (1,:) bevutil1.CodeUtil.DoubleValue
  ...
  properties
    ...
    SideNoteUIWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = 1
    ...
    SideNoteUI bevutil1.AppUtil.Component.Label
  ...
  methods (Access=protected)
    ...
    function setup(component)
      ...
      component.double_value = bevutil1.CodeUtil.DoubleValue;
      ...
      component.NameUI.Text = bevutil1.CodeUtil.i18n("Double value");
      ...
      component.SideNoteUI = bevutil1.AppUtil.Component.Label(component.sidenote_layout);
  ...
  methods
    ...
    function updateInfoUI(component)
      ...
      squashed_value_text = bevutil1.CodeUtil.squashCodeText(bevutil1.CodeUtil.stringify(dbl_val));

classdef Hyperlink < bevutil1.AppUtil.Component.ComponentBase
  % Hyperlink component
  ...
  properties
    ...
    HyperlinkClickedCallback {bevutil1.CodeUtil.mustBeFunctionHandleOrEmpty} = []

    ComponentWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = "1x";
    HyperlinkWidth (1,:) {bevutil1.CodeUtil.mustBeTextOrPositiveNumber} = "fit";

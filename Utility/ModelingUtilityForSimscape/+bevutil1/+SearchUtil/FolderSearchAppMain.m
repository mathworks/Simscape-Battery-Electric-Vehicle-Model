classdef FolderSearchAppMain < handle
  ...
  properties
    ...
    SearchFolderNameUI bevutil1.AppUtil.Component.DropDown
  ...
  methods
    ...
    function App = FolderSearchAppMain(NameValuePair)
      ...
      App.Window.Name = bevutil1.CodeUtil.i18n("Folder search");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + bevutil1.CodeUtil.i18n("Folder name to search") + "}";

      % -----------------------------------------------------------------------
      v_layout = addVerticalGridLayout(main_v_container);

      App.SearchFolderNameUI = bevutil1.AppUtil.Component.DropDown(v_layout);
      ...
      App.TopFolderUI = bevutil1.AppUtil.Component.DropDown(v_layout);
      ...
      App.CopyCommandButtonUI = bevutil1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
      ...
      App.SearchButtonUI = bevutil1.AppUtil.Component.Button(addHorizontalGridLayout(h_container));
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if App.SearchFolderNameUI.Value == ""
        ...
        App.CommandText = "bevutil1.SearchUtil.searchFolders(""" + App.SearchFolderNameUI.Value + """, TopFolder=""" + top_folder + """)";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      top_folder = replace(App.TopFolderUI.Value, " > ", filesep);
      App.SearchResult = bevutil1.SearchUtil.searchFolders(App.SearchFolderNameUI.Value, TopFolder=top_folder);

      if isempty(App.SearchResult)
        uialert(App.Window.MainFigure, bevutil1.CodeUtil.i18n("Folder was not found."), bevutil1.CodeUtil.i18n("Not found"))

        return

      end  % if

      bevutil1.SearchUtil.FolderSearchResultAppMain( ...

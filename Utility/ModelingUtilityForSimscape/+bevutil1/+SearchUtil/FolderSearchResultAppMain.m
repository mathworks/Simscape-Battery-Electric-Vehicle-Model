classdef FolderSearchResultAppMain < handle
  ...
  methods
    ...
    function App = FolderSearchResultAppMain(NameValuePair)
      ...
      App.Window.Name = bevutil1.CodeUtil.i18n("Folder search result");
    ...
    function build_app_gui(App)
      ...
      App.NewSearchButtonUI.MainButton.Tooltip = bevutil1.CodeUtil.i18n("Open the folder search app.");
      ...
      label_ui = bevutil1.AppUtil.Component.Label(addHorizontalGridLayout(h_container, Width="fit"));
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = bevutil1.CodeUtil.i18n("Searched folder name");
      ...
      App.RefreshButtonUI = bevutil1.AppUtil.Component.Button(addHorizontalGridLayout(h_container, Width="fit"));
      ...
      label_ui.Text = bevutil1.CodeUtil.i18n("Double-click a table row to change to the folder.");
      ...
      if App.SearchResult ~= ""
        ...
        App.TableUI.MainTable.ColumnName = bevutil1.CodeUtil.i18n("Folder path");
    ...
    function react_NewSearch(App)
      if App.TopFolder ~= "" && App.SearchFolderName ~= ""
        bevutil1.SearchUtil.FolderSearchAppMain(TopFolder=App.TopFolder, SearchFolderName=App.SearchFolderName)
      else
        bevutil1.SearchUtil.FolderSearchAppMain
      end  % if
    end  % function

    function react_RefreshButtonPushed(App)
      FolderPath = bevutil1.SearchUtil.searchFolders(App.SearchFolderName, TopFolder=App.TopFolder);

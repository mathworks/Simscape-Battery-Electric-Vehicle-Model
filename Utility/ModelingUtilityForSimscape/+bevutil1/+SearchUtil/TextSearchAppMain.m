classdef TextSearchAppMain < handle
  ...
  properties
    ...
    TextSearcher (1,1) bevutil1.SearchUtil.TextSearcher = bevutil1.SearchUtil.TextSearcher
    SearchResult table
    ...
    SearchTextUI bevutil1.AppUtil.Component.DropDown
    IgnoreCaseUI bevutil1.AppUtil.Component.CheckBox
    MatchWholeWordUI bevutil1.AppUtil.Component.CheckBox

    TargetFolderUI bevutil1.AppUtil.Component.DropDown
    IncludeSubfoldersUI bevutil1.AppUtil.Component.CheckBox
    SelectFolderUI bevutil1.AppUtil.Component.Button

    SelectAllUI bevutil1.AppUtil.Component.CheckBox
    Search_m_UI bevutil1.AppUtil.Component.CheckBox
    Search_md_UI bevutil1.AppUtil.Component.CheckBox
    Search_mdl_UI bevutil1.AppUtil.Component.CheckBox
    Search_ssc_UI bevutil1.AppUtil.Component.CheckBox
    Search_svg_UI bevutil1.AppUtil.Component.CheckBox
    CustomFileTypesUI bevutil1.AppUtil.Component.EditField

    % SpecifiedFileTypesUI is read-only.
    SpecifiedFileTypesUI bevutil1.AppUtil.Component.EditField

    ExcludeLiveScriptUI bevutil1.AppUtil.Component.CheckBox
    ExcludeMATLABCodeFileUI bevutil1.AppUtil.Component.CheckBox
  ...
  methods
    ...
    function App = TextSearchAppMain(NameValuePair)
      ...
      arguments (Input)
        ...
        NameValuePair.SearchStates (1,:) bevutil1.SearchUtil.TextSearchStates
      ...
      App.Window.Name = bevutil1.CodeUtil.i18n("Text search");
      ...
      switch NameValuePair.StatesSource
        ...
        case "external"
          if not(isfield(NameValuePair, "SearchStates"))
            ...
            msg = bevutil1.CodeUtil.i18n("For external initial states, SearchStates must be specified.");
    ...
    function build_app_gui(App)
      ...
      label_ui.Text = "\textbf{" + bevutil1.CodeUtil.i18n("Text to search") + "}";

      App.IgnoreCaseUI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.IgnoreCaseUI.Text = bevutil1.CodeUtil.i18n("Ignore case");
      App.IgnoreCaseUI.ValueChangedCallback = @() update_SearcherStatesFromUIComponents(App);

      App.MatchWholeWordUI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.MatchWholeWordUI.Text = bevutil1.CodeUtil.i18n("Match whole word");
      App.MatchWholeWordUI.ValueChangedCallback = @() update_SearcherStatesFromUIComponents(App);

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);

      App.SearchTextUI = bevutil1.AppUtil.Component.DropDown(column_grid);
      ...
      label_ui = bevutil1.AppUtil.Component.Label(row_grid);
      label_ui.ComponentWidth = App.width_name_ui;
      label_ui.Text = "\textbf{" + bevutil1.CodeUtil.i18n("Target folder") + "}";

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.IncludeSubfoldersUI = bevutil1.AppUtil.Component.CheckBox(row_grid);
      App.IncludeSubfoldersUI.Text = bevutil1.CodeUtil.i18n("Include subfolders");
      ...
      App.TargetFolderUI = bevutil1.AppUtil.Component.DropDown(column_grid);
      ...
      label_ui.Text = "\textbf{" + bevutil1.CodeUtil.i18n("File types") + "}";

      % -----------------------------------------------------------------------
      column_grid = addVerticalGridLayout(main_vertical_container);
      horizontal_container = bevutil1.AppUtil.HorizontalContainer(column_grid);

      App.SelectAllUI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.SelectAllUI.Text = bevutil1.CodeUtil.i18n("Select all");
      App.SelectAllUI.ValueChangedCallback = @() react_SearchAllFileTypesCheckBox(App);

      App.Search_m_UI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_m_UI.Text = bevutil1.CodeUtil.i18n("*.m");
      App.Search_m_UI.MainCheckBox.Tooltip = bevutil1.CodeUtil.i18n("MATLAB files");
      App.Search_m_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_md_UI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_md_UI.Text = bevutil1.CodeUtil.i18n("*.md");
      App.Search_md_UI.MainCheckBox.Tooltip = bevutil1.CodeUtil.i18n("Markdown files");
      App.Search_md_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_mdl_UI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_mdl_UI.Text = bevutil1.CodeUtil.i18n("*.mdl");
      App.Search_mdl_UI.MainCheckBox.Tooltip = bevutil1.CodeUtil.i18n("Simulink model files");
      App.Search_mdl_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_ssc_UI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_ssc_UI.Text = bevutil1.CodeUtil.i18n("*.ssc");
      App.Search_ssc_UI.MainCheckBox.Tooltip = bevutil1.CodeUtil.i18n("Simscape source files");
      App.Search_ssc_UI.ValueChangedCallback = @() update_FileTypes(App);

      App.Search_svg_UI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container));
      App.Search_svg_UI.Text = bevutil1.CodeUtil.i18n("*.svg");
      App.Search_svg_UI.MainCheckBox.Tooltip = bevutil1.CodeUtil.i18n("Scalable vector graphics files");
      ...
      label_ui.Text = bevutil1.CodeUtil.i18n("Custom file types");
      label_ui.ComponentWidth = App.width_name_ui;

      App.CustomFileTypesUI = bevutil1.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container));
      App.CustomFileTypesUI.MainEditField.Tooltip = bevutil1.CodeUtil.i18n("Specify a comma-separated list of file types. Example: demo*.m, *.txt");
      ...
      label_ui = bevutil1.AppUtil.Component.Label(addHorizontalGridLayout(horizontal_container, Width="fit"));
      label_ui.Text = bevutil1.CodeUtil.i18n("Specified file types");
      label_ui.ComponentWidth = App.width_name_ui;

      App.SpecifiedFileTypesUI = bevutil1.AppUtil.Component.EditField(addHorizontalGridLayout(horizontal_container));
      ...
      App.ExcludeLiveScriptUI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.ExcludeLiveScriptUI.Text = bevutil1.CodeUtil.i18n("Exclude Live Script files from *.m");
      App.ExcludeLiveScriptUI.ValueChangedCallback = @() update_FileTypes(App);

      App.ExcludeMATLABCodeFileUI = bevutil1.AppUtil.Component.CheckBox(addHorizontalGridLayout(horizontal_container, Width="fit"));
      App.ExcludeMATLABCodeFileUI.Text = bevutil1.CodeUtil.i18n("Exclude MATLAB code files from *.m");
    ...
    function update_SearcherStatesFromUIComponents(App)
      ...
      if not(ready(App.TextSearcher))
        ...
        App.CommandText = "bevutil1.SearchUtil.searchText(" + getCommandArgumentText(App.TextSearcher) + ")";
      end  % if
    end  % function
    ...
    function react_SearchButtonPushed(App)
      ...
      if isempty(App.SearchResult)
        uialert(App.MainFigure, bevutil1.CodeUtil.i18n("Nothing matched."), bevutil1.CodeUtil.i18n("No match"))

        return

      end  % if

      bevutil1.SearchUtil.TextSearchResultAppMain(App.TextSearcher, SearchResult=App.SearchResult)

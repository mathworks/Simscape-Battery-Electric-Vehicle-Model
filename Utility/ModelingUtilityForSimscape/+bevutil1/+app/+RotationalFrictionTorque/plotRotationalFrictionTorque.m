...
arguments (Input)
  ...
  NameValuePair.DataSet bevutil1.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet {mustBeScalarOrEmpty}
...
if NameValuePair.DataSource == "direct"
  ...
  if isfield(NameValuePair, "DataSet")
    ...
    data_source = bevutil1.app.RotationalFrictionTorque.RotationalFrictionTorqueDataSet( ...
      Initialization=true);
  end  % if

classdef Vehicle1DForceModelParameters
  ...
  properties
    ...
    TireRollingCoefficient (1,1) double { bevutil1.CodeUtil.mustBePositiveOrNan } = nan

    % Air drag coefficient
    AirDragCoefficient (1,1) double { bevutil1.CodeUtil.mustBePositiveOrNan } = nan
    ...
    MaxAcceleration (1,1) double { bevutil1.CodeUtil.mustBePositiveOrNan } = nan
    ...
    MaxClimbPower (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxClimbPower, "kW"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "kW")

    % Vehicle's maximum driving force
    MaxForce (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(MaxForce, "N"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
    ...
    RoadLoadA (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(RoadLoadA, "N"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...
      = simscape.Value(nan, "N")

    % The road-load coefficient C
    RoadLoadC (1,1) simscape.Value ...
      { simscape.mustBeCommensurateUnit(RoadLoadC, "N/(m/s)^2"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan } ...

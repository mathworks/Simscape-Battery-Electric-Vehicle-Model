classdef Vehicle1DForcePresets
  ...
  properties (SetAccess=immutable)
    PresetDictionary = configureDictionary("string", "bevutil1.app.Vehicle1DForce.Vehicle1DForceDataSet")
  end  % properties
  ...
  methods
    ...
    function PresetDictionary = Vehicle1DForcePresets()
      ...
      data_set = bevutil1.app.Vehicle1DForce.Vehicle1DForceDataSet;

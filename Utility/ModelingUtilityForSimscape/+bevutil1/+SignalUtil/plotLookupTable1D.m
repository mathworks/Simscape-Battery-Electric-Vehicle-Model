...
%
% This function takes x for input data points and y for output data points.
...
%
% The Interpreter option for the tile, xlabel, and ylabel is "latex".
...
arguments (Input)
  ...
  NameValuePair.Interpreter (1,1) string {mustBeMember(NameValuePair.Interpreter, ["latex", "none"])} = "latex"
...
xlabel(ax, x_label_string, Interpreter=NameValuePair.Interpreter)
...
ylabel(ax, y_label_string, Interpreter=NameValuePair.Interpreter)

classdef SignalDesignAppMain < handle
  ...
  properties
    ...
    MatrixTextUI bevutil1.AppUtil.Component.TextArea
    InterpUI bevutil1.AppUtil.Component.DropDown
    ExtrapUI bevutil1.AppUtil.Component.DropDown

    TableGridVectorUI bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel
    TableValuesUI bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel
    ...
    IntervalUI bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel
    AutoRangeUI bevutil1.AppUtil.Component.CheckBox
    LowerUI bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel
    UpperUI bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel
  ...
  properties (Constant, Access=private)
    ...
    name_ui_width = bevutil1.AppUtil.Constant.Width{"unitwidth"} * 18
    unit_ui_width = bevutil1.AppUtil.Constant.Width{"unitwidth"} * 8
  ...
  methods
    ...
    function App = SignalDesignAppMain(NameValuePair)
      ...
      arguments (Output)
        App bevutil1.SignalUtil.SignalDesignAppMain
      end  % arguments
      ...
      App.Window.Name = bevutil1.CodeUtil.i18n("Signal Design App");
    ...
    function build_app_gui(App)
      ...
      html_file = "SignalDesignApp_Description_bevutil1.html";
      ...
      App.MatrixTextUI = bevutil1.AppUtil.Component.TextArea(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      horizontal_container = bevutil1.AppUtil.HorizontalContainer(left_column_grid);
      ...
      App.InterpUI= bevutil1.AppUtil.Component.DropDown(row_grid);
      ...
      row_grid = addHorizontalGridLayout(horizontal_container);
      App.ExtrapUI= bevutil1.AppUtil.Component.DropDown(row_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      App.TableGridVectorUI = bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);
      App.TableValuesUI = bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel(left_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.IntervalUI = bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.AutoRangeUI = bevutil1.AppUtil.Component.CheckBox(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.LowerUI = bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
      ...
      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      App.UpperUI = bevutil1.AppUtil.Component.PhysicalValueWithUnitLabel(right_column_grid);
    ...
    function change_design_matrix(App)
      ...
      result = bevutil1.SignalUtil.getVectorsFromSignalDesignMatrix(design_matrix);

      App.TableGridVectorUI.ValueText = bevutil1.CodeUtil.stringify(result.X');
      App.TableValuesUI.ValueText = bevutil1.CodeUtil.stringify(result.F');
    ...
    function check_design_matrix(App)
      ...
      result = bevutil1.SignalUtil.checkSignalDesignMatrix(design_matrix);
    ...
    function getParam(App)
      ...
      try
        ...
        bevutil1.SignalUtil.getSignalDesignMatrixFromBlockDescription(block_path);
      catch exception
        % Restore the previous plot auto-update setting.
        App.UpdateButtonUI.CheckBoxUI.Value = previous_auto_plot_state;
        if App.Window.MainFigure.Visible
    ...
    function update_plot(App, NameValuePair)
      ...
      if App.AutoRangeUI.Value
        vec = bevutil1.CodeUtil.getNumberArrayFromText(App.TableGridVectorUI.ValueText);
        lb = vec(1);
        ub = vec(end);

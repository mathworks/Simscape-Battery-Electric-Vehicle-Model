classdef TraceGeneratorAppMain < handle
  ...
  properties
    ...
    RandomSeedUI bevutil1.AppUtil.Component.DoubleValueUI

    InitialValueUI bevutil1.AppUtil.Component.DoubleValueUI
    InitialValueDurationUI bevutil1.AppUtil.Component.DoubleValueUI

    FirstTransitionDurationUI bevutil1.AppUtil.Component.DoubleValueUI

    NumberOfTransitionsUI bevutil1.AppUtil.Component.DoubleValueUI
    TransitionDurationRangeUI bevutil1.AppUtil.Component.DoubleValueUI
    ConstantDurationRangeUI bevutil1.AppUtil.Component.DoubleValueUI
    ValueRangeUI bevutil1.AppUtil.Component.DoubleValueUI

    FinalTransitionDurationUI bevutil1.AppUtil.Component.DoubleValueUI

    FinalValueUI bevutil1.AppUtil.Component.DoubleValueUI
    FinalValueDurationUI bevutil1.AppUtil.Component.DoubleValueUI

    TableGridVectorUI bevutil1.AppUtil.Component.DoubleValueUI
    TableValuesUI bevutil1.AppUtil.Component.DoubleValueUI
    ...
    IntervalUI bevutil1.AppUtil.Component.DoubleValueUI

    SelectorUI bevutil1.AppUtil.Component.BlockSelectorUI
  end  % properties
  ...
  methods
    ...
    function App = TraceGeneratorAppMain(NameValuePair)
      ...
      if NameValuePair.BlockPath ~= ""
        ...
        App.ModelFileFullPath = bevutil1.FileUtil.getFileFullPath(model_name);
      ...
      App.Window.Name = bevutil1.CodeUtil.i18n("Trace Generator App");
    ...
    function build_app_gui(App)
      ...
      main_horizontal_container = bevutil1.AppUtil.HorizontalContainer(main_column_grid);

      % =======================================================================
      % Left area
      % =======================================================================
      left_row_grid = addHorizontalGridLayout(main_horizontal_container);
      left_vertical_container = bevutil1.AppUtil.VerticalContainer(left_row_grid);
      ...
      html_file = bevutil1.CodeUtil.i18n("TraceGeneratorApp_Description_bevutil1.html");
      bevutil1.FileUtil.getFileFullPath(html_file);

      link_ui = bevutil1.AppUtil.Component.Hyperlink(left_column_grid);
      link_ui.Text = bevutil1.CodeUtil.i18n("Description");
      link_ui.HyperlinkClickedCallback =  @() web(html_file);

      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);

      label_ui = bevutil1.AppUtil.Component.Label(left_column_grid);
      label_ui.Text = bevutil1.CodeUtil.i18n("\textbf{Parameters}");

      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);

      App.RandomSeedUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.RandomSeedUI.NameText = bevutil1.CodeUtil.i18n("Random seed");
      ...
      App.InitialValueUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.InitialValueUI.NameText = bevutil1.CodeUtil.i18n("Initial value, $f_0$");
      ...
      App.InitialValueDurationUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.InitialValueDurationUI.NameText = bevutil1.CodeUtil.i18n("Initial value duration, $d_0$");
      ...
      App.FirstTransitionDurationUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.FirstTransitionDurationUI.NameText = bevutil1.CodeUtil.i18n("Initial transition duration, $h_0$");
      ...
      App.ValueRangeUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.ValueRangeUI.NameText = bevutil1.CodeUtil.i18n("Value range, $V$");
      ...
      App.NumberOfTransitionsUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.NumberOfTransitionsUI.NameText = bevutil1.CodeUtil.i18n("Number of transitions, $n$");
      ...
      App.TransitionDurationRangeUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.TransitionDurationRangeUI.NameText = bevutil1.CodeUtil.i18n("Transition duration range, $T$");
      ...
      App.ConstantDurationRangeUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.ConstantDurationRangeUI.NameText = bevutil1.CodeUtil.i18n("Constant duration range, $C$");
      ...
      App.FinalTransitionDurationUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.FinalTransitionDurationUI.NameText = bevutil1.CodeUtil.i18n("Final transition duration, $h_f$");
      ...
      App.FinalValueUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.FinalValueUI.NameText = bevutil1.CodeUtil.i18n("Final value, $f_f$");
      ...
      App.FinalValueDurationUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.FinalValueDurationUI.NameText = bevutil1.CodeUtil.i18n("Final value duration, $d_f$");
      ...
      label_ui = bevutil1.AppUtil.Component.Label(left_column_grid);
      label_ui.Text = bevutil1.CodeUtil.i18n("\textbf{Derived parameters}");

      % -----------------------------------------------------------------------
      left_column_grid = addVerticalGridLayout(left_vertical_container);

      App.TableGridVectorUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.TableGridVectorUI.NameText = bevutil1.CodeUtil.i18n("Table grid vector, $x$");
      ...
      App.TableValuesUI = bevutil1.AppUtil.Component.DoubleValueUI(left_column_grid);
      App.TableValuesUI.NameText = bevutil1.CodeUtil.i18n("Table values, $f(x)$");
      ...
      right_vertical_container = bevutil1.AppUtil.VerticalContainer(right_row_grid);

      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);
      horizontal_container = bevutil1.AppUtil.HorizontalContainer(right_column_grid);

      row_grid = addHorizontalGridLayout(horizontal_container, Width="fit");
      App.UpdateButtonUI = bevutil1.AppUtil.Component.EnabledButton(row_grid);
      ...
      App.OpenInFigureWindowUI = bevutil1.AppUtil.Component.Hyperlink(row_grid);
      ...
      App.AxesUI = bevutil1.AppUtil.Graphics.Axes(right_column_grid);
      App.AxesUI.ComponentHeight = 326;

      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);

      label_ui = bevutil1.AppUtil.Component.Label(right_column_grid);
      label_ui.Text = bevutil1.CodeUtil.i18n("\textbf{Visualization parameter}");

      % -----------------------------------------------------------------------
      right_column_grid = addVerticalGridLayout(right_vertical_container);

      App.IntervalUI = bevutil1.AppUtil.Component.DoubleValueUI(right_column_grid);
      App.IntervalUI.NameText = bevutil1.CodeUtil.i18n("Interpolation interval");
      ...
      % =======================================================================
      main_column_grid = addVerticalGridLayout(main_vertical_container);
      bevutil1.AppUtil.Component.HorizontalLine(main_column_grid);
      ...
      App.SelectorUI = bevutil1.AppUtil.Component.BlockSelectorUI(main_column_grid);
      App.SelectorUI.TargetSimscapeBlockNames = "PS Lookup Table (1D)";
      App.SelectorUI.FindBlockCallback = @bevutil1.ModelUtil.findLookupTable1DBlocks;
    ...
    function update_plot(App, NameValuePair)
      ...
      App.TableGridVectorUI.ValueText = bevutil1.CodeUtil.stringify(x_data');
      App.TableGridVectorUI.ValueTextUI.MainEditField.Tooltip = App.TableGridVectorUI.ValueText;

      App.TableValuesUI.ValueText = bevutil1.CodeUtil.stringify(f_data');
      App.TableValuesUI.ValueTextUI.MainEditField.Tooltip = App.TableValuesUI.ValueText;

      dx = bevutil1.CodeUtil.getNumericValueFromText(App.IntervalUI.ValueText);
    ...
    function data_table = get_signal_design_matrix_from_UI_components(App)
      ...
      try
        random_seed = bevutil1.CodeUtil.getNumericValueFromText(App.RandomSeedUI.ValueText);
        initial_value = bevutil1.CodeUtil.getNumericValueFromText(App.InitialValueUI.ValueText);
        initial_value_duration = bevutil1.CodeUtil.getNumericValueFromText(App.InitialValueDurationUI.ValueText);
        initial_transition_duration = bevutil1.CodeUtil.getNumericValueFromText(App.FirstTransitionDurationUI.ValueText);

        num_trans = bevutil1.CodeUtil.getNumericValueFromText(App.NumberOfTransitionsUI.ValueText);

        trans_du_range = App.TransitionDurationRangeUI.ValueText;

        range_of_transition_duration = bevutil1.CodeUtil.getNumberArrayFromText(trans_du_range);

        const_dur_range = App.ConstantDurationRangeUI.ValueText;

        range_of_constant_duration = bevutil1.CodeUtil.getNumberArrayFromText(const_dur_range);

        dat_val_range = App.ValueRangeUI.ValueText;

        range_of_data_value = bevutil1.CodeUtil.getNumberArrayFromText(dat_val_range);

        final_transition_duration = bevutil1.CodeUtil.getNumericValueFromText(App.FinalTransitionDurationUI.ValueText);

        final_value = bevutil1.CodeUtil.getNumericValueFromText(App.FinalValueUI.ValueText);

        final_value_duration = bevutil1.CodeUtil.getNumericValueFromText(App.FinalValueDurationUI.ValueText);

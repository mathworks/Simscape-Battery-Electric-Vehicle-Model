...
% Example:
%
%   bev1mus_TextSearchApp(TargetFolder=pwd, SearchText="hello", IgnoreCase=true)
%
...
%   bev1mus_TextSearchApp(StatesSource="external", SearchStates=states)
%
...
arguments (Output)
  App bev1mus.SearchUtil.TextSearchAppMain {mustBeScalarOrEmpty}
end  % arguments

switch NameValuePair.StatesSource

  case "options"
    app_main = bev1mus.SearchUtil.TextSearchAppMain( ...
      StatesSource = "options", ...

...
arguments (Input)
  ...
  NameValuePair.XLabel (1,1) string = LiteApp5.Utility.i18n("Time")
...
if isempty(NameValuePair.Timetable)
  ...
  msg = LiteApp5.Utility.i18n("Empty Timetable is not allowed.");
...
if isempty(NameValuePair.SignalName) || NameValuePair.SignalName==""
  ...
  msg = LiteApp5.Utility.i18n("Empty SignalName is not allowed.");
...
if isempty(ydata)
  ...
  msg = LiteApp5.Utility.i18n("Empty ydata is not allowed.");

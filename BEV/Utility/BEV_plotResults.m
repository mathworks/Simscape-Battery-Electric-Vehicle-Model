...
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("Reference Vehicle Speed kph"), dy_threshold=2);
...
hold(ax, "on")
grid(ax, "on")
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("G-Force"), dy_threshold=0.02);
ylabel(ax, "")  % Hide variable name defined in the timetable.
xlim(ax, "tight")
xlabel(ax, "")
title(ax, "G-Force (-)")
...
hold(ax, "on")
grid(ax, "on")
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("Motor Torque Command"), dy_threshold=2);
ylabel(ax, "")  % Hide variable name defined in the timetable.
xlim(ax, "tight")
xlabel(ax, "")
...
if plotTemp
  ...
  hold(ax, "on")
  grid(ax, "on")
  bevutil1.SignalUtil.setMinimumYRange(ax, simData.("Motor Temperature"), dy_threshold=2);
  ylabel(ax, "")  % Hide variable name defined in the timetable.
  xlim(ax, "tight")
  xlabel(ax, "")
...
hold(ax, "on")
grid(ax, "on")
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("HV Battery SOC"), dy_threshold=0.2);
ylabel(ax, "")  % Hide variable name defined in the timetable.
xlim(ax, "tight")
xlabel(ax, "")
...
hold(ax, "on")
grid(ax, "on")
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("HV Battery Current"), dy_threshold=2);
ylabel(ax, "")  % Hide variable name defined in the timetable.
xlim(ax, "tight")
xlabel(ax, "")
...
hold(ax, "on")
grid(ax, "on")
bevutil1.SignalUtil.setMinimumYRange(ax, simData.("HV Battery Power"), dy_threshold=2);
ylabel(ax, "")  % Hide variable name defined in the timetable.
xlim(ax, "tight")
xlabel(ax, "")
...
if plotTemp
  ...
  hold(ax, "on")
  grid(ax, "on")
  bevutil1.SignalUtil.setMinimumYRange(ax, simData.("HV Battery Temperature"), dy_threshold=2);
  ylabel(ax, "")  % Hide variable name defined in the timetable.
  xlim(ax, "tight")
  xlabel(ax, "")

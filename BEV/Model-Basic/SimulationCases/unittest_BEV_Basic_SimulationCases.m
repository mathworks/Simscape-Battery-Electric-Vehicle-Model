classdef unittest_BEV_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "BEV_Basic_Constant";
    ...
    function PassingTest_3(testcase)
      %%
      target_name = "BEV_Basic_HighSpeed";
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

classdef unittest_Reducer_Basic < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "Reducer_Basic_params";  % !test-target
    ...
    function PassingTest_2(testcase)
      %%
      target_name = "Reducer_Basic_refsub";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_3(testcase)
      %%
      target_name = "setupLogging_Reducer_Basic";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

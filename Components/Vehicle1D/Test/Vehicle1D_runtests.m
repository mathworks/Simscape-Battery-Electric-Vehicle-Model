...
plugin = matlab.unittest.plugins.CodeCoveragePlugin.forFile( ...
  [ ...
  fullfile(TopFolder, "Configuration", "Vehicle1D_loadSimulationCase.m")
  fullfile(TopFolder, "Configuration", "Vehicle1D_loadSimulationCase_Accelerate.m")
  fullfile(TopFolder, "Configuration", "Vehicle1D_loadSimulationCase_Braking.m")
  fullfile(TopFolder, "Configuration", "Vehicle1D_loadSimulationCase_Coastdown.m")
  fullfile(TopFolder, "Configuration", "Vehicle1D_loadSimulationCase_Constant.m")
  ...
  fullfile(TopFolder, "Harness", "Vehicle1D_harness_setup.m")
  ...
  fullfile(TopFolder, "TestCases", "Vehicle1D_testcase_Accelerate.mlx")
  fullfile(TopFolder, "TestCases", "Vehicle1D_testcase_Braking.mlx")
  fullfile(TopFolder, "TestCases", "Vehicle1D_testcase_Coastdown.mlx")
  fullfile(TopFolder, "TestCases", "Vehicle1D_testcase_Constant.mlx")
  ...

classdef testui_Vehicle1DPerformanceDesignApp < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate(testcase)
      ...
      source_fullpath = FileTool1.getFileFullPath("Vehicle1DPerformanceDesignAppMain.m");

      destination_fullpath = FileTool1.getFileFullPath("screenshot-Vehicle1DPerformanceDesignApp.png");

...
BrakeForceInput.SignalDesignMatrix = [
  0 1 0 ... from time 0 to time 1, constant value 0
  ];
...
AxleTorqueInput.DesignMatrix = [
  0   10  0   ;  ... from time 0 to time 10, constant value 0
  30  100 400 ;  ... from time 30 to time 100, constant value 400
  140 200 900 ];

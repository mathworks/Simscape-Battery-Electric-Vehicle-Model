classdef unittest_Vehicle1D_Inputs_settings < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function RefSub_IconLabel_1(testcase)
      ...
      refsub_name = "Inputs_Vehicle1D_Accelerate_refsub";
      icon_label = "Accelerate";
    ...
    function RefSub_IconLabel_2(testcase)
      ...
      refsub_name = "Inputs_Vehicle1D_Braking_refsub";
      icon_label = "Braking";
    ...
    function RefSub_IconLabel_3(testcase)
      ...
      refsub_name = "Inputs_Vehicle1D_Coastdown_refsub";
      icon_label = "Coastdown";
    ...
    function RefSub_IconLabel_4(testcase)
      % Check that the referenced subsystem has an icon label.

      refsub_name = "Inputs_Vehicle1D_Constant_refsub";
      icon_label = "Constant";

classdef Vehicle1DPerformanceParameters
  ...
  properties
    ...
    VehicleMass (1,1) simscape.Value { ...
      ...
      CodeTool1.mustBeSimscapeValuePositive } ...
    ...
    RoadLoadB (1,1) simscape.Value { ...
      ...
      CodeTool1.mustBeSimscapeValueNonnegative } ...
      ...
      function sscval = get_simscape_value(name)
        ...
        if isnan(v)
          try
            ...
            msg = CodeTool1.i18n("The evaluation of the specified block property failed: ") + name + newline + ...
              CodeTool1.i18n("The property value was " + block_properties(name));

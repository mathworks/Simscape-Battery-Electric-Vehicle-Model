classdef Vehicle1DPerformanceParameters
  ...
  properties
    ...
    VehicleMass (1,1) simscape.Value { ...
      ...
      LiteApp6.SimscapeUtility.mustBeSimscapeValuePositive } ...
    ...
    RoadLoadB (1,1) simscape.Value { ...
      ...
      LiteApp6.SimscapeUtility.mustBeSimscapeValueNonnegative } ...
  ...
  methods
    ...
    function Param = getParametersFromBlock(Param, BlockPath)
      ...
      try
        block_properties = LiteApp6.SimscapeUtility.buildPropertyDictionaryFromBlock(BlockPath);
      catch exception
      ...
      function sscval = get_simscape_value(name)
        ...
        if isnan(v)
          try
            ...
            msg = LiteApp6.Utility.i18n("The evaluation of the specified block property failed: ") + name + newline + ...
              LiteApp6.Utility.i18n("The property value was " + block_properties(name));

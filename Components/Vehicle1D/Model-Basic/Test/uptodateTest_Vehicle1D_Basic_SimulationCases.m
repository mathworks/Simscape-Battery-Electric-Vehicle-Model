classdef uptodateTest_Vehicle1D_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function markdowns_are_uptodate(testcase)
      ...
      top_folder = fullfile(currentProject().RootFolder, "Components", "Vehicle1D", "Model-Basic");
      ...
      num_conversions = FileUtil1.batchGenerateMarkdowns( ...
        DryRun = false, ...

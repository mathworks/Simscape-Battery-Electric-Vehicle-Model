classdef Vehicle1D_test_Basic_simulation_cases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_Accelerate_1(~)
      Vehicle1D_Basic_Accelerate
    end

    function MQC_Braking_1(~)
      Vehicle1D_Basic_Braking
    end

    function MQC_Coastdown_1(~)
      Vehicle1D_Basic_Coastdown
    end

    function MQC_Constant_1(~)
      Vehicle1D_Basic_Constant
    end

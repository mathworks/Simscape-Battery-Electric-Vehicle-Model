classdef test_BEVController_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      % For example, extract "Basic" from "test_BEVController_Basic_SimulationCases".
      id = extractBetween(string(mfilename), "test_BEVController_", "_SimulationCases");

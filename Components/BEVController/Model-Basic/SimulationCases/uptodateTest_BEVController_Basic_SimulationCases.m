classdef uptodateTest_BEVController_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      % For example, extract "Basic" from "uptodateTest_BEVController_Basic_SimulationCases".
      id = extractBetween(string(mfilename), "uptodateTest_BEVController_", "_SimulationCases");
  ...
  methods (Test)
    ...
    function markdown_files_exist(testcase)
      ...
      logical_index = bevutil1.FileUtil.isPlainTextLiveScript(m_files);

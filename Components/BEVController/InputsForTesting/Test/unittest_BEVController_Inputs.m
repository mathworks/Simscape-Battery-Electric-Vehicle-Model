classdef unittest_BEVController_Inputs < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      ...
      set_param(block_path, ReferencedSubsystem="Inputs_BEVController_Random_refsub")  % !test-target
    ...
    function PassingTest_2(~)
      ...
      load_system(model_name)
      block_path = "HarnessModel_BEVController_Inputs/Inputs";
      set_param(block_path, ReferencedSubsystem="Inputs_BEVController_Simple_refsub")  % !test-target
      sim(model_name);  % !test-target
    end  % function

    function PassingTest_3(~)
      BuildInputs_BEVController_Random
    end  % function

    function PassingTest_4(~)
      BuildInputs_BEVController_Simple
    end  % function

classdef uptodateTest_VehSpdRef_LUT < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function screenshot_is_uptodate_1(testcase)
      %%
      model_name = "VehSpdRef_LookupTable_refsub";  %!screenshot-target
      image_filename = "screenshot-VehSpdRef_LookupTable_refsub.png";
    ...
    function plot_image_is_uptodate_1(testcase)
      %%
      source_name = "loadLUTData_VehSpdRef_Simple.m";  %!screenshot-target
      image_filename = "plot-VehSpdRef_Simple.png";
      ...
      if source_is_newer
        ...
        % This script loads VehicleSpeedRef in the base workspace.
        evalin("base", "loadLUTData_VehSpdRef_Simple")

        x = evalin("base", "VehicleSpeedRef");
        fig = createPlot_VehSpdRef(x, SpeedUnit="km/hr");
    ...
    function plot_image_is_uptodate_2(testcase)
      %%
      source_name = "BuildData_VehSpdRef_HighSpeed.m";  %!screenshot-target
      image_filename = "plot-VehSpdRef_HighSpeed.png";
      ...
      if source_is_newer
        ...
        data_table = BuildData_VehSpdRef_HighSpeed();
        fig = createPlot_VehSpdRef(data_table, SpeedUnit="km/hr");

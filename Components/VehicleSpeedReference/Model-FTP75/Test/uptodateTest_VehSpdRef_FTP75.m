classdef uptodateTest_VehSpdRef_FTP75 < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function screenshot_is_uptodate_1(testcase)
      %%
      model_name = "VehSpdRef_FTP75_refsub";  %!screenshot-target
      image_filename = "screenshot-VehSpdRef_FTP75_refsub.png";

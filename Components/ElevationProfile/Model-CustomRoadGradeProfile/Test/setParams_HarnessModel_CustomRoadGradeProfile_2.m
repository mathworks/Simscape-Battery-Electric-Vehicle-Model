...
sim_in = setBlockParameter(sim_in, block_path, constant_unit = "mph");
...
sim_in = setBlockParameter(sim_in, block_path, x_vector_unit = "mi");

% Road grade profile (percent)
sim_in = setBlockParameter(sim_in, block_path, grade_vector = "[ -10 -10 -10 ]");
...
sim_in = setBlockParameter(sim_in, block_path, left_elevation_unit = "ft");

% Initial horizontal position
sim_in = setBlockParameter(sim_in, block_path, initial_position = "0");
sim_in = setBlockParameter(sim_in, block_path, initial_position_unit = "mi");

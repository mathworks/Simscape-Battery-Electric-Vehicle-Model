classdef unittest_CtrlEnv_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_LiveScript_1(testcase)
      target_name = "CtrlEnv_Basic_Constant";  % !test-target
    ...
    function PassingTest_LiveScript_2(testcase)
      target_name = "CtrlEnv_Basic_FTP75";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_LiveScript_3(testcase)
      target_name = "CtrlEnv_Basic_HighSpeed";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_LiveScript_4(testcase)
      target_name = "CtrlEnv_Basic_Simple";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

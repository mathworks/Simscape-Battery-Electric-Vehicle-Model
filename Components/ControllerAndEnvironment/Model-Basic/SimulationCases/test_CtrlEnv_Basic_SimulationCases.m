classdef test_CtrlEnv_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      % For example, extract "Basic" from "test_CtrlEnv_Basic_SimulationCases".
      id = extractBetween(string(mfilename), "test_CtrlEnv_", "_SimulationCases");

classdef uptodateTest_CtrlEnv_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      % For example, extract "Basic" from "uptodateTest_CtrlEnv_Basic_SimulationCases".
      id = extractBetween(string(mfilename), "uptodateTest_CtrlEnv_", "_SimulationCases");

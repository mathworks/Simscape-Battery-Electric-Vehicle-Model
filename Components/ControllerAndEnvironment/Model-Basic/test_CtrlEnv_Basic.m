classdef test_CtrlEnv_Basic < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      % Run script, for example, CtrlEnv_Basic_params.
      target_name = "CtrlEnv_" + testcase.ModelID + "_params";
    ...
    function simulation_ends_quickly(testcase)
      target_model = "CtrlEnv_TestModel";

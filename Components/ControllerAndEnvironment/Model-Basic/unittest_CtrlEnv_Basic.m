classdef unittest_CtrlEnv_Basic < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(~)
      evalin("base", "CtrlEnv_Basic_params")  % !test-target
    end  % function
    ...
    function PassingTest_2(~)
      ...
      sim_in = setBlockParameter( sim_in, ...
        model_name + "/Controller and Environment", ...
        ReferencedSubsystem = "CtrlEnv_Basic_refsub" );

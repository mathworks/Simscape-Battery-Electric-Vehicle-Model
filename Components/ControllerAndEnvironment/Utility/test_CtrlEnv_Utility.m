classdef test_CtrlEnv_Utility < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1_error(testcase)
      verifyError(testcase, @() CtrlEnv_ResultsPlot(), "MATLAB:nonExistentField")
    end  % function

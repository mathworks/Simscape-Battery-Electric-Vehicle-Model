...
arguments (Input)
  NameValuePair.Capacity (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.Capacity, "kWh"), CodeUtil1.mustBeSimscapeValuePositiveOrNan} ...
    = simscape.Value(40, "kWh")
  NameValuePair.Voltage (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.Voltage, "V"), CodeUtil1.mustBeSimscapeValuePositiveOrNan} ...
...
arguments (Output)
  Charge (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(Charge, "A*hr"), CodeUtil1.mustBeSimscapeValuePositiveOrNan}
end  % arguments

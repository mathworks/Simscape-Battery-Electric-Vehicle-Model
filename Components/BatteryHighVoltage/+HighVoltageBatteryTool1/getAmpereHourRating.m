...
arguments (Input)
  NameValuePair.Capacity (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.Capacity, "kWh"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan} ...
    = simscape.Value(40, "kWh")
  NameValuePair.Voltage (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(NameValuePair.Voltage, "V"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan} ...
...
arguments (Output)
  Charge (1,1) simscape.Value ...
    {simscape.mustBeCommensurateUnit(Charge, "A*hr"), bevutil1.CodeUtil.mustBeSimscapeValuePositiveOrNan}
end  % arguments

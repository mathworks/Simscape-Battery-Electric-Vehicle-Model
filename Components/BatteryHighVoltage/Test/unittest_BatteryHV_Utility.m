classdef unittest_BatteryHV_Utility < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1_1(~)
      HighVoltageBatteryTool1.refineOCVData;
    end  % function
    ...
    function PassingTest_2_1(~)
      HighVoltageBatteryTool1.refineTerminalResistanceData;
    end  % function

    function PassingTest_2_2(~)
      SampleScript_BatteryHV_refineTerminalResistanceData
    end  % function

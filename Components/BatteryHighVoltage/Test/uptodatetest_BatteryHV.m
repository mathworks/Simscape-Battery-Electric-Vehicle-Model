classdef uptodatetest_BatteryHV < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function html_is_uptodate(testcase)
      ...
      destination_fullpath = bevutil1.FileUtil.getFileFullPath("BatteryHV_Description.html");
      ...
      newer = bevutil1.FileUtil.sourceFileIsNewer(Source=source_fullpath, Destination=destination_fullpath, DisplayInfo=true);
    ...
    function model_screenshot_is_uptodate(testcase)
      ...
      destination_fullpath = bevutil1.FileUtil.getFileFullPath(image_filename);

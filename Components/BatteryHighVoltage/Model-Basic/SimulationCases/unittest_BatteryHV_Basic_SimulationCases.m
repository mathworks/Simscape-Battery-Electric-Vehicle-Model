classdef unittest_BatteryHV_Basic_SimulationCases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      target_name = "BatteryHV_Basic_Charge";  % !test-target
    ...
    function PassingTest_2(testcase)
      target_name = "BatteryHV_Basic_Constant";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_3(testcase)
      target_name = "BatteryHV_Basic_Discharge";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_4(testcase)
      target_name = "BatteryHV_Basic_Random";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

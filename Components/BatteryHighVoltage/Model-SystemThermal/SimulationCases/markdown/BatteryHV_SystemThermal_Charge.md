...
BatteryHV_setRefsub_SystemTable
```

```matlabTextOutput
Model: BatteryHV_TestModel
Setting up referenced subsystem: BatteryHV_SystemTable_refsub
```
...
<center><img src="media/BatteryHV_SystemThermal_Charge_media/figure_0.png" width="702" alt="figure_0.png"></center>

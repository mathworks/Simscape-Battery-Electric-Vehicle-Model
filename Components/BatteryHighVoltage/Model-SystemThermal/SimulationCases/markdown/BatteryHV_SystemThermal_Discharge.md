...
BatteryHV_setRefsub_SystemThermal
```

```matlabTextOutput
Model: BatteryHV_TestModel
Setting up referenced subsystem: BatteryHV_SystemThermal_refsub
```
...
<center><img src="media/BatteryHV_SystemThermal_Discharge_media/figure_0.png" width="702" alt="figure_0.png"></center>

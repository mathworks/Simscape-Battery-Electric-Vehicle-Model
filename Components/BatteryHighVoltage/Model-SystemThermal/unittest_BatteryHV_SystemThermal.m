classdef unittest_BatteryHV_SystemThermal < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "BatteryHV_SystemThermal_params";  % !test-target
    ...
    function PassingTest_2(testcase)
      %%
      target_name = "BatteryHV_SystemThermal_refsub";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

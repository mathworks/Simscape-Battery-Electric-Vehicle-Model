...
SignalTool2.setMinimumYRange(ax, vals, dy_threshold=0.2);
xlim([t(1) t(end)])
xlabel(ax, "Time (s)")
...
plot(ax, t, vals, LineWidth=2)
hold on;  grid on
SignalTool2.setMinimumYRange(ax, vals, dy_threshold=2);
xlim([t(1) t(end)])
xlabel(ax, "Time (s)")
...
plot(ax, t, vals, LineWidth=2)
hold on;  grid on
SignalTool2.setMinimumYRange(ax, vals, dy_threshold=0.02);
xlim([t(1) t(end)])
xlabel(ax, "Time (s)")

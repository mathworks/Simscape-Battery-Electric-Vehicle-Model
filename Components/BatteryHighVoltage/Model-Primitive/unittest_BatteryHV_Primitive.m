classdef unittest_BatteryHV_Primitive < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "BatteryHV_Primitive_params";  % !test-target
    ...
    function PassingTest_2(testcase)
      %%
      target_name = "BatteryHV_Primitive_refsub";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

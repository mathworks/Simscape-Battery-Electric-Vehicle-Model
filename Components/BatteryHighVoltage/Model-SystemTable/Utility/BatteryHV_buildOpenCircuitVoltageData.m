...
% Open-circuit voltage V0(SOC,T) parameter of Tabled-Based Battery block
...
% second column is OCV in Volts.
%
% For example, a 2-by-2 matrix [15 3.1; 25 3.3] represents that
% - 1st row: 15 percent SOC, 3.1 V OCV
% - 2nd row: 25 percent SOC, 3.3 V OCV
%
...
BatteryHV_buildOpenCircuitVoltageData( ...
  ...
  MakePlot = true )
%}
% Temperature points must be sorted in strictly increasing order.
%

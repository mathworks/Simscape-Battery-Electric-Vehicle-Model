function BatteryHV_setRefsub(nvpairs)
...
arguments
  nvpairs.ModelName {mustBeTextScalar} = "BatteryHV_TestModel"
  nvpairs.BlockPath {mustBeTextScalar} = "/High Voltage Battery"
  nvpairs.RefsubName {mustBeTextScalar}    = "BatteryHV_Basic_refsub"
  nvpairs.ParamFileName {mustBeTextScalar} = "BatteryHV_Basic_params"
end

classdef unittest_BatteryHV_Inputs_settings < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PreLoadFcn_for_parameters(testcase)
      ...
      parameter_filename = "HarnessSetup_BatteryHV_Inputs";  % without ".m"
    ...
    function RefSub_IconLabel_1(testcase)
      ...
      refsub_name = "Inputs_BatteryHV_Charge_refsub";
      icon_label = "Charge";
    ...
    function RefSub_IconLabel_2(testcase)
      ...
      refsub_name = "Inputs_BatteryHV_Constant_refsub";
      icon_label = "Constant";
    ...
    function RefSub_IconLabel_3(testcase)
      ...
      refsub_name = "Inputs_BatteryHV_Random_refsub";
      icon_label = "Random";

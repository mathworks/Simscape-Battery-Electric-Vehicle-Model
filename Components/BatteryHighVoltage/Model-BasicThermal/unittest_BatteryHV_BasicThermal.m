classdef unittest_BatteryHV_BasicThermal < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "BatteryHV_BasicThermal_params";  % !test-target
    ...
    function PassingTest_2(testcase)
      %%
      target_name = "BatteryHV_BasicThermal_refsub";  % !test-target
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

classdef MotorDriveUnit_test_System < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_load_parameters_1(~)
      MotorDriveUnit_refsub_System_params  % !test-target
    end  % function

    function MQC_load_refsub_1(testcase)
      load_system(testcase.ModelName)
      MotorDriveUnit_useRefsub_System  % !test-target
    end  % function
    ...
    function MQC_note_SystemModelEfficiency_1(~)
      evalin("base", "MotorDriveUnit_note_SystemModelEfficiency")
    end  % function
    ...
    function test_MotorDriveUnit_getBlockInfo_System_1(testcase)
      ...
      evalin("base", "MotorDriveUnit_refsub_System_params")

      model_name = "MotorDriveUnit_refsub_System";
      ...
      info = MotorDriveUnit_getBlockInfo_System;  % !test-target

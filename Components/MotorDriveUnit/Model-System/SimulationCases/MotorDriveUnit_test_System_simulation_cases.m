classdef MotorDriveUnit_test_System_simulation_cases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_Constant_1(~)
      MotorDriveUnit_System_Constant  % !test-target
    end  % function

    function MQC_Drive_1(~)
      MotorDriveUnit_System_Drive  % !test-target
    end  % function

    function MQC_Random_1(~)
      MotorDriveUnit_System_Random  % !test-target
    end  % function

    function MQC_RegenBrake_1(~)
      MotorDriveUnit_System_RegenBrake  % !test-target
    end  % function

classdef test_MotorDriveUnit_Utility < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_2_error(testcase)
      verifyError(testcase, @() MotorDriveUnit_ResultsPlot(), "MATLAB:nonExistentField")
    end  % function

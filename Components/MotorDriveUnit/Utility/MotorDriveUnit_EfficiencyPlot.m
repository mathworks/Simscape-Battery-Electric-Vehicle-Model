...
arguments (Input)
  ...
  NameValuePair.MaxSpeed (1,1) simscape.Value {LiteApp6.SimscapeUtility.mustBeSimscapeValuePositive} = simscape.Value(17000, "rpm")

  NameValuePair.MaxTorque (1,1) simscape.Value {LiteApp6.SimscapeUtility.mustBeSimscapeValuePositive} = simscape.Value(163, "N*m")
  NameValuePair.MaxPower (1,1) simscape.Value {LiteApp6.SimscapeUtility.mustBeSimscapeValuePositive} = simscape.Value(53, "kW")
  ...
  % i.e., they are 0. 
  NameValuePair.IronToNominalLossRatioPercent (1,1) simscape.Value {LiteApp6.SimscapeUtility.mustBeSimscapeValueNonnegative} = simscape.Value(0.1, "1")
  NameValuePair.FixedLoss (1,1) simscape.Value {LiteApp6.SimscapeUtility.mustBeSimscapeValueNonnegative} = simscape.Value(40, "W")
...
xlabel(ax, LiteApp6.Utility.i18n("Speed, $\omega$ (rpm)"), Interpreter="latex")

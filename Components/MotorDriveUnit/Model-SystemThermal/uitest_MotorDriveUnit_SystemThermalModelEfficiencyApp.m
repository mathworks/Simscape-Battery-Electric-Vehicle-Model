classdef uitest_MotorDriveUnit_SystemThermalModelEfficiencyApp < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate(testcase)
      ...
      source_fullpath = FileUtil1.getFileFullPath("MotorDriveUnit_SystemThermalModelEfficiencyApp.m");
      destination_fullpath = FileUtil1.getFileFullPath("screenshot-MDU-SystemThermalModelEfficiencyApp.png");

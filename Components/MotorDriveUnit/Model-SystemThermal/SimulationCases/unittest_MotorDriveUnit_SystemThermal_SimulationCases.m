classdef unittest_MotorDriveUnit_SystemThermal_SimulationCases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function PassingTest_1(testcase)
      %%
      target_name = "MotorDriveUnit_SystemThermal_Constant";
    ...
    function PassingTest_2(testcase)
      %%
      target_name = "MotorDriveUnit_SystemThermal_Drive";
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_3(testcase)
      %%
      target_name = "MotorDriveUnit_SystemThermal_Random";
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);
    ...
    function PassingTest_4(testcase)
      %%
      target_name = "MotorDriveUnit_SystemThermal_RegenBrake";
      target_fullpath = bevutil1.FileUtil.getFileFullPath(target_name);

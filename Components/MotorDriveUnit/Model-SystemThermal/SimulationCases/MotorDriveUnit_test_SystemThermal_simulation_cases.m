classdef MotorDriveUnit_test_SystemThermal_simulation_cases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_Constant_1(~)
      MotorDriveUnit_SystemThermal_Constant  % !test-target
    end  % function

    function MQC_Drive_1(~)
      MotorDriveUnit_SystemThermal_Drive  % !test-target
    end  % function

    function MQC_Random_1(~)
      MotorDriveUnit_SystemThermal_Random  % !test-target
    end  % function

    function MQC_RegenBrake_1(~)
      MotorDriveUnit_SystemThermal_RegenBrake  % !test-target
    end  % function

classdef test_MotorDriveUnit_SystemThermal_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      % For example, extract "Basic" from "test_MotorDriveUnit_Basic_SimulationCases".

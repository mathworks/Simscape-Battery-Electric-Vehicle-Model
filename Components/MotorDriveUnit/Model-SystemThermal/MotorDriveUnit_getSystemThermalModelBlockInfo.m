...
info.IronLoss = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "Piron");

% Fixed losses independent of torque and speed
info.FixedLoss = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "Pbase");

% External supply series resistance is 0 and not used.

% Rotor inertia
info.RotorInertia = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "J");

% Rotor damping
info.RotorDamping = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "lam");

% Initial rotor speed
info.InitialRotorSpeed = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "speed0");
...
% Thermal mass
info.ThermalMass = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "thermal_mass");

% Initial temperature
info.InitialTemperature = bevutil1.ModelUtil.getSimscapeValueFromBlockParameter(fullpathToBlock, "initial_temperature");

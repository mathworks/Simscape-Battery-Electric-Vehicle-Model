classdef uptodatetest_MotorDriveUnit_SystemThermal < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function plot_image_is_uptodate(testcase)
      ...
      % This is in the Utility folder.
      source_fullpath = FileUtil1.getFileFullPath("MotorDriveUnit_EfficiencyPlot.m");

      destination_fullpath = FileUtil1.getFileFullPath("screenshot-MDU-SystemThermalModelEfficiencyPlot.png");

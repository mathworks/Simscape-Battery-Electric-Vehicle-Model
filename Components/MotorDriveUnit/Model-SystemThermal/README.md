# Motor Drive Unit System Model

## Description

This folder contains a `System` version of a Motor Drive Unit (MDU)
as [a referenced subsystem][doc-refsub] component.
To run simulation, use a harness model provided with this component.

- Referenced subsystem file: `MotorDriveUnit_refsub_System.mdl`
- Parameter file: `MotorDriveUnit_refsub_System_params.m`
...
Use the app `MotorDriveUnitEfficiencyApp_System` to see
the map of electro-mechanical power conversion efficiency.

<img src="screenshot-MotorDriveUnitEfficiencyApp_System.png"
     alt="Motor Drive Unit Efficiency App for the System MDU model"
     width="800">

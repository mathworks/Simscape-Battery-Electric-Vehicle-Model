classdef MotorDriveUnit_test_BasicThermal < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_load_parameters_1(~)
      MotorDriveUnit_refsub_BasicThermal_params  % !test-target
    end  % function

    function MQC_load_refsub_1(testcase)
      load_system(testcase.ModelName)
      MotorDriveUnit_useRefsub_BasicThermal  % !test-target
    end  % function

classdef test_MotorDriveUnit_BasicThermal_SimulationCases < matlab.unittest.TestCase
  ...
  methods (TestClassSetup)
    ...
    function setup_ModelID(testcase)
      ...
      id = extractBetween(string(mfilename), "test_MotorDriveUnit_", "_SimulationCases");

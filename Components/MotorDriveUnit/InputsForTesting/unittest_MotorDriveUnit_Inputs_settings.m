classdef unittest_MotorDriveUnit_Inputs_settings < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function RefSub_IconLabel_1(testcase)
      ...
      refsub_name = "Inputs_MotorDriveUnit_Constant_refsub";
      icon_label = "Constant";
    ...
    function RefSub_IconLabel_2(testcase)
      ...
      refsub_name = "Inputs_MotorDriveUnit_Drive_refsub";
      icon_label = "Drive";
    ...
    function RefSub_IconLabel_3(testcase)
      ...
      refsub_name = "Inputs_MotorDriveUnit_Random_refsub";
      icon_label = "Random";
    ...
    function RefSub_IconLabel_4(testcase)
      ...
      refsub_name = "Inputs_MotorDriveUnit_RegenBrake_refsub";
      icon_label = "RegenBrake";

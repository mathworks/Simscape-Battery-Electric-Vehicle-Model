%% Setup script for Motor Drive Unit test model
%
% If you edit this file, make sure to run this to update variables
% in the base workspace before running simulation.
%
% This script sets up parameters for the following models with generic values.
% - Basic model
% - Basic thermal model
% - System-level model
% - System-level model with tabulated losses
%
% Some parameters are overridden by other scripts that are specific to individual models.
% - MotorDriveUnit_Basic_params.m
% - MotorDriveUnit_BasicThermal_params.m
% - MotorDriveUnit_refsub_System_params.m
% - MotorDriveUnit_refsub_SystemTable_params.m

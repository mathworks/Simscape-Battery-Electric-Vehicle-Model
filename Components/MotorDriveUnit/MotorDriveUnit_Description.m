...
%[text] - [Drive](matlab:openFileInProject('MotorDriveUnit_Basic_Drive')) ... MDU drives axle by consuming electric power.
%[text] - [Regenerative braking](matlab:openFileInProject('MotorDriveUnit_Basic_RegenBrake')) ... Axle drives motor, and MDU generates electric power.
%[text] - [Random](matlab:openFileInProject('MotorDriveUnit_Basic_Random')) .... Input signals for motor torque command and axle load torque are randomly generated.
%[text] - [Constant](matlab:openFileInProject('MotorDriveUnit_Basic_Constant')) ... All inputs are constant. This is used to check that the harness model runs. \

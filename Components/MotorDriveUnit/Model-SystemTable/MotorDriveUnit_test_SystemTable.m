classdef MotorDriveUnit_test_SystemTable < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_load_parameters_1(~)
      MotorDriveUnit_refsub_SystemTable_params  % !test-target
    end  % function

    function MQC_load_refsub_1(testcase)
      load_system(testcase.ModelName)
      MotorDriveUnit_useRefsub_SystemTable  % !test-target
    end  % function

classdef uitest_MotorDriveUnit_BasicModelEfficiencyApp < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate(testcase)
      ...
      source_fullpath = FileUtil1.getFileFullPath("MotorDriveUnit_BasicModelEfficiencyApp.m");
      destination_fullpath = FileUtil1.getFileFullPath("screenshot-MDU-BasicModelEfficiencyApp.png");

classdef MotorDriveUnit_test_Basic < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_load_parameters_1(~)
      MotorDriveUnit_refsub_Basic_params  % !test-target
    end  % function

    function MQC_load_refsub_1(~)
      load_system("MotorDriveUnit_refsub_Basic")  % !test-target
    end  % function

    function MQC_refsub_setup_1(~)
      MotorDriveUnit_useRefsub_Basic  % !test-target
    end  % function

    function MQC_BasicModelEfficiencyPlot_1(~)
      MotorDriveUnit_BasicModelEfficiencyPlot
    end  % function

    function MQC_note_BasicModelEfficiency_1(~)
      evalin("base", "MotorDriveUnit_note_BasicModelEfficiency")
    end  % function

    %% other tests

    function test_MotorDriveUnit_getBlockInfo_Basic_1(testcase)
      %%
      ...
      model_name = "MotorDriveUnit_refsub_Basic";
      ...
      info = MotorDriveUnit_getBlockInfo_Basic;  % !test-target

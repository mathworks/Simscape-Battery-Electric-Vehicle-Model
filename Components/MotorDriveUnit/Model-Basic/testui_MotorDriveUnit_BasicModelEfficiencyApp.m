classdef testui_MotorDriveUnit_BasicModelEfficiencyApp < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate(testcase)
      ...
      source_fullpath = FileTool1.getFileFullPath("MotorDriveUnit_BasicModelEfficiencyApp.m");
      destination_fullpath = FileTool1.getFileFullPath("screenshot-MDU-BasicModelEfficiencyApp.png");

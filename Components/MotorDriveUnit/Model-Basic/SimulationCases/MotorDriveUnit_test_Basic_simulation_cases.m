classdef MotorDriveUnit_test_Basic_simulation_cases < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function MQC_Constant_1(~)
      MotorDriveUnit_Basic_Constant  % !test-target
    end  % function

    function MQC_Drive_1(~)
      MotorDriveUnit_Basic_Drive  % !test-target
    end  % function

    function MQC_Random_1(~)
      MotorDriveUnit_Basic_Random  % !test-target
    end  % function

    function MQC_RegenBrake_1(~)
      MotorDriveUnit_Basic_RegenBrake  % !test-target
    end  % function

...
arguments (Input)
  NameValuePair.MaxTorque (1,1) simscape.Value {CodeTool1.mustBeSimscapeValuePositive} = simscape.Value(420, "N*m")
  NameValuePair.MaxSpeed (1,1) simscape.Value {CodeTool1.mustBeSimscapeValuePositive} = simscape.Value(15000, "rpm")
  NameValuePair.MaxPower (1,1) simscape.Value {CodeTool1.mustBeSimscapeValuePositive} = simscape.Value(220, "kW")
  ...
  NameValuePair.RotorDamping (1,1) simscape.Value {CodeTool1.mustBeSimscapeValueNonnegative} = simscape.Value(0, "N*m/(rad/s)")

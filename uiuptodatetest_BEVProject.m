classdef uiuptodatetest_BEVProject < matlab.uitest.TestCase
  ...
  methods (Test)
    ...
    function app_screenshot_is_uptodate(testcase)
      ...
      source_fullpath = FileTool3.getFileFullPath("BEVProjectNavigationAppMain.m");

      destination_fullpath = FileTool3.getFileFullPath("screenshot-BEVProjectNavigationApp.png");
